...
public struct AnnotationAnchorDTO:Codable,Sendable,Equatable { public let documentId:String; public let pageNumber:Int; public let startOffset:Int?; public let endOffset:Int?; public let selectedText:String? }
