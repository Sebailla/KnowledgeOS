...
Defines replaceable provider contracts for source-faithful, reflowed, preview and print rendering while preserving UDM/DPM mappings and keeping renderer-specific objects outside Domain contracts.
