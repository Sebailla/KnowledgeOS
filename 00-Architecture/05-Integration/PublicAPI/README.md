...
Defines the rector boundary for REST, GraphQL and Local API transports over approved Platform contracts, including authentication, versioning, errors, idempotency and compatibility.
