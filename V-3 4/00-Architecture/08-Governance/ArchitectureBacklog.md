...
A consistent active ADR baseline aligned with V3 without rewriting historical decisions. The original historical ADR source files were not present in the supplied archive; this limitation is recorded in `../../AUDIT-ADR-CONSOLIDATION.md`.
...
* AB-001 — Architecture V3 Cross-Document Consistency Validation;
* AB-002 — Architecture V3 Internal Reference Validation;
* AB-003 — Architecture Views Reconstruction for V3;
