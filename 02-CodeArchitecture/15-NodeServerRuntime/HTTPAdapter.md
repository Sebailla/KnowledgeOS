...
> # Native HTTP Adapter
> The adapter translates `node:http` requests into KnowledgeOS `HttpRequest` values and serializes `HttpResponse` values.
> Responsibilities:
> - method and path;
> - normalized headers;
> - query decoding;
