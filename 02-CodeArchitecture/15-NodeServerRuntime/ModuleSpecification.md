        # Runtime de servidor Node.js — Module Specification
        ...
        **Last updated:** 2026-08-02
        ...
        Define ciclo de vida, adaptador HTTP, seguridad, boundary del runtime e integración ejecutable en Node.js.
        ...
        | Package | Role |
        |---|---|
        | `packages/infrastructure-postgres-node` | Implementación o contratos asociados a Runtime de servidor Node.js. |
| `packages/observability` | Implementación o contratos asociados a Runtime de servidor Node.js. |
