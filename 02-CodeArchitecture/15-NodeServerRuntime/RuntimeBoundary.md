...
**Project:** KnowledgeOS  
**Section:** `02-CodeArchitecture/15-NodeServerRuntime`  
**Document:** `RuntimeBoundary.md`  
**Documentation version:** 5.6.1  
**Status:** Consolidated  
**Last updated:** 2026-08-02  
**Implemented by:** `packages/infrastructure-postgres-node`, `packages/observability`
...
Cubre **Runtime Boundary** dentro de **Runtime de servidor Node.js**. Define ciclo de vida, adaptador HTTP, seguridad, boundary del runtime e integración ejecutable en Node.js. Delimita los componentes, flujos y consumidores cubiertos, evitando convertir el documento en una descripción global del producto. No redefine Product Vision, arquitectura de dominio global ni políticas operativas pertenecientes a otros directorios.
...
> # Runtime Boundary
> `@knowledgeos/server-node` owns Node.js runtime details only.
> It may depend on `@knowledgeos/server` and Node standard-library APIs. It SHALL NOT contain Domain rules, Library use cases or SQL repository behavior.
