...
> # Next Step
> The next block is PostgreSQL runtime integration:
> - concrete database driver adapter;
> - migration runner;
> - PostgreSQL readiness check;
> - transaction-aware repository composition;
> - outbox publisher;
