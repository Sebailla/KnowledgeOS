# Module Specification — 46-SearchEnginePart7
...
- `ChangeEvents.md` — Change Events concern and its subsystem-specific contracts, invariants, operations, failure behavior, and verification.
...
- `IncrementalInvalidation.md` — Incremental Invalidation concern and its subsystem-specific contracts, invariants, operations, failure behavior, and verification.
...
- `LiveSubscriptions.md` — Live Subscriptions concern and its subsystem-specific contracts, invariants, operations, failure behavior, and verification.
...
- `QueryHistory.md` — Query History concern and its subsystem-specific contracts, invariants, operations, failure behavior, and verification.
- `README.md` — Readme concern and its subsystem-specific contracts, invariants, operations, failure behavior, and verification.
- `ResultDeltas.md` — Result Deltas concern and its subsystem-specific contracts, invariants, operations, failure behavior, and verification.
- `ResultSnapshots.md` — Result Snapshots concern and its subsystem-specific contracts, invariants, operations, failure behavior, and verification.
...
- `SavedSearches.md` — Saved Searches concern and its subsystem-specific contracts, invariants, operations, failure behavior, and verification.
