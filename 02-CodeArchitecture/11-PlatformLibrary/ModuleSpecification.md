        # Biblioteca de plataforma — Module Specification
        ...
        **Last updated:** 2026-08-02
        ...
        Define casos de uso, puertos, adaptadores y operaciones iniciales de la biblioteca sobre contratos de dominio.
        ...
        | Package | Role |
        |---|---|
        | `packages/library` | Implementación o contratos asociados a Biblioteca de plataforma. |
| `packages/local-library` | Implementación o contratos asociados a Biblioteca de plataforma. |
