...
> # First Vertical Slice
> RegisterLocalSourceCommand → handler → Domain objects → repositories → committed events → GetLocalAvailabilityQuery.
