...
**Document:** `AcquisitionRequest.md`  
...
> # Acquisition Request
> Validates target Local Library and Master Catalog publication, then creates an Acquisition aggregate. It does not transfer bytes or synchronize Personal Knowledge.
