...
> # Library Use Cases
> Implemented use cases: register local source, browse Master Catalog, request acquisition, resolve local availability and list a Local Library.
