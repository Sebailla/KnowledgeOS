...
**Document:** `AvailabilityQueries.md`  
...
> # Availability Queries
> Local availability is derived from Local Library membership and distinguishes offline-readable local content from unavailable or evicted content.
