...
> # Ports and Adapters
> Ports include repositories, MasterCatalogReader, identity generation, committed event publication and UnitOfWork. In-memory adapters are provided for tests.
