...
**Project:** KnowledgeOS  
**Section:** `02-CodeArchitecture/11-PlatformLibrary`  
**Document:** `RegisterLocalSource.md`  
**Documentation version:** 5.6.1  
**Status:** Consolidated  
**Last updated:** 2026-08-02  
**Implemented by:** `packages/library`, `packages/local-library`

## 1. Purpose

El tema **Register Local Source** se interpreta dentro de Biblioteca de plataforma y debe conservar límites explícitos, semántica determinista y trazabilidad. Establece la razón de existencia del documento y la decisión de ingeniería que gobierna. Este documento convierte una descripción breve en una especificación verificable y mantiene la terminología de KnowledgeOS.

## 2. Scope

Cubre **Register Local Source** dentro de **Biblioteca de plataforma**. Define casos de uso, puertos, adaptadores y operaciones iniciales de la biblioteca sobre contratos de dominio. Delimita los componentes, flujos y consumidores cubiertos, evitando convertir el documento en una descripción global del producto. No redefine Product Vision, arquitectura de dominio global ni políticas operativas pertenecientes a otros directorios.
...
> # Register Local Source
> Creates SourceItem, KnowledgeObject, initial PublicationVersion and Local Library membership as one logical application operation. Events publish only after repository writes complete.
