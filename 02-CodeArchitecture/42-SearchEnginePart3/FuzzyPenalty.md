...
- defining a typed and owner-scoped representation of edit-distance candidates, thresholds, penalties, expansion budgets, and false-positive control;
...
The normative flow for edit-distance candidates, thresholds, penalties, expansion budgets, and false-positive control is:
...
Results obtained through fuzzy matching receive a configurable penalty.

Exact matches therefore remain preferred when all other signals are equal.
