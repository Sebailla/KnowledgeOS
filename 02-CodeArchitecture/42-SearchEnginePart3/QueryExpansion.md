...
The module exists to build the offline-first lexical, structured, fuzzy, semantic, hybrid, embedding, and graph-aware retrieval pipeline used by Library, AI, Reader, Workspace, plugins, and MCP. This document narrows that broader purpose to **Query Expansion**, establishes its observable guarantees, and records where responsibility begins and ends.
...
Terms can expand through:

- typo correction;
- synonyms;
- domain-specific equivalents.

Expansion remains explicit and inspectable.
