# Module Specification — 42-SearchEnginePart3
...
- `ExplainableScores.md` — score decomposition, provenance, stage timing, and user-facing diagnostics.
- `FuzzyMatching.md` — edit-distance candidates, thresholds, penalties, expansion budgets, and false-positive control.
- `FuzzyPenalty.md` — edit-distance candidates, thresholds, penalties, expansion budgets, and false-positive control.
- `NextStep.md` — implemented boundary, intentionally deferred capabilities, prerequisites, and compatibility constraints.
- `PersonalKnowledgeBoost.md` — owner-specific boosts, privacy boundary, bounded contribution, and explanation.
- `QueryExpansion.md` — query language grammar, parsing, validation, canonical AST, and execution planning.
...
- `RankingProfiles.md` — score components, normalization, profiles, deterministic ties, personalization, and explanations.
- `Recency.md` — time decay, reference time, configuration, missing dates, and deterministic scoring.
- `Runtime.md` — the runtime concern within the Search Engine subsystem, including contracts, invariants, runtime behavior, persistence, failure handling, and verification.
- `Testing.md` — unit, integration, property, failure-injection, persistence, concurrency, and end-to-end verification.
- `TypoTolerance.md` — the typo tolerance concern within the Search Engine subsystem, including contracts, invariants, runtime behavior, persistence, failure handling, and verification.
