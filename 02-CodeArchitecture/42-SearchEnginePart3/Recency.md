...
- defining a typed and owner-scoped representation of time decay, reference time, configuration, missing dates, and deterministic scoring;
...
The normative flow for time decay, reference time, configuration, missing dates, and deterministic scoring is:
...
Recency uses a deterministic decay curve based on days since update.

It never replaces lexical relevance; its influence is profile-dependent.
