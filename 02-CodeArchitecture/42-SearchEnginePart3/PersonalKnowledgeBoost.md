...
**Document:** Personal Knowledge Boost  
...
- defining a typed and owner-scoped representation of owner-specific boosts, privacy boundary, bounded contribution, and explanation;
...
The normative flow for owner-specific boosts, privacy boundary, bounded contribution, and explanation is:
...
The personal profile can prioritize notes, highlights and annotations without changing the underlying lexical index.
