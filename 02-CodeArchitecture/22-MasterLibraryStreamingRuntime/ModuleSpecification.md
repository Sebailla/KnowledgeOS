...
Runtime de streaming de la master library existe para implementa upload y download progresivos, rangos, backpressure y validación de caché. Esta especificación gobierna sus documentos subordinados y la implementación ubicada en `packages/master-library-streaming-runtime`.
