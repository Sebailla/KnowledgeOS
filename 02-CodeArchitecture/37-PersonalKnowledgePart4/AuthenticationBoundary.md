...
The transport validates the configured authorization header.

Credential issuance, refresh and secure storage remain external to the synchronization domain.
