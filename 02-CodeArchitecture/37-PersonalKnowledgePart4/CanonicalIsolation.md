...
- defining a typed and owner-scoped representation of separation between canonical shared knowledge and owner-specific personal projections;
...
The normative flow for separation between canonical shared knowledge and owner-specific personal projections is:
...
The server exchanges Personal Knowledge records only.

Master Publication bytes and Local Publication objects never enter this transport.
