...
- defining a typed and owner-scoped representation of the server store concern within the Personal Knowledge subsystem, including contracts, invariants, runtime behavior, persistence, failure handling, and verification;
...
The normative flow for the server store concern within the Personal Knowledge subsystem, including contracts, invariants, runtime behavior, persistence, failure handling, and verification is:
...
The initial server store is transport-focused and replaceable.

Production deployment will use PostgreSQL persistence and owner-scoped access checks.
