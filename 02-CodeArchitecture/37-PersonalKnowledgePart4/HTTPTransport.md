...
- defining a typed and owner-scoped representation of the h t t p transport concern within the Personal Knowledge subsystem, including contracts, invariants, runtime behavior, persistence, failure handling, and verification;
...
The normative flow for the h t t p transport concern within the Personal Knowledge subsystem, including contracts, invariants, runtime behavior, persistence, failure handling, and verification is:
...
- `POST /v1/personal-knowledge/sync`
- `GET /v1/personal-knowledge/sync?ownerId=...&deviceId=...`

Both require an authorization header.
