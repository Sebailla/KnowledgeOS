...
Composición productiva de biblioteca local existe para coordina caché, mantenimiento, runtime Node SQLite, recuperación y compatibilidad de plataforma. Esta especificación gobierna sus documentos subordinados y la implementación ubicada en `packages/local-library-runtime`.
