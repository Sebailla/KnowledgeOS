...
**Project:** KnowledgeOS  
**Section:** `02-CodeArchitecture/10-DomainFoundation`  
**Document:** `FirstVerticalSlice.md`  
**Documentation version:** 5.6.1  
**Status:** Consolidated  
**Last updated:** 2026-08-02  
**Implemented by:** `packages/domain`, `packages/domain-types`

## 1. Purpose

El tema **First Vertical Slice** se interpreta dentro de Fundación de dominio y debe conservar límites explícitos, semántica determinista y trazabilidad. Establece la razón de existencia del documento y la decisión de ingeniería que gobierna. Este documento convierte una descripción breve en una especificación verificable y mantiene la terminología de KnowledgeOS.

## 2. Scope

Cubre **First Vertical Slice** dentro de **Fundación de dominio**. Define agregados, Knowledge Objects, adquisición, biblioteca local, conocimiento personal y contratos de repositorio. Delimita los componentes, flujos y consumidores cubiertos, evitando convertir el documento en una descripción global del producto. No redefine Product Vision, arquitectura de dominio global ni políticas operativas pertenecientes a otros directorios.
...
> # First Vertical Slice
> Register source → create Knowledge Object → register publication version → add Local Library membership → resolve availability → publish Domain events.
