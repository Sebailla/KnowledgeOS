        # Fundación de dominio — Module Specification
        ...
        **Last updated:** 2026-08-02
        ...
        Define agregados, Knowledge Objects, adquisición, biblioteca local, conocimiento personal y contratos de repositorio.
        ...
        | Package | Role |
        |---|---|
        | `packages/domain` | Implementación o contratos asociados a Fundación de dominio. |
| `packages/domain-types` | Implementación o contratos asociados a Fundación de dominio. |
