# Arquitectura de pruebas — Module Specification
...
Define pirámide de pruebas, conformidad contractual, pruebas arquitectónicas y criterios de cobertura por riesgo.
...
| Package | Role |
|---|---|
| `packages/testing` | Implementación o contratos asociados a Arquitectura de pruebas. |
