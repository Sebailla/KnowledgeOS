...
**Project:** KnowledgeOS  
**Section:** `02-CodeArchitecture/06-Testing`  
**Document:** `TestArchitecture.md`  
**Documentation version:** 5.6.1  
**Status:** Consolidated  
**Last updated:** 2026-08-02  
**Implemented by:** `packages/testing`
...
Cubre **Test Architecture** dentro de **Arquitectura de pruebas**. Define pirámide de pruebas, conformidad contractual, pruebas arquitectónicas y criterios de cobertura por riesgo. Delimita los componentes, flujos y consumidores cubiertos, evitando convertir el documento en una descripción global del producto. No redefine Product Vision, arquitectura de dominio global ni políticas operativas pertenecientes a otros directorios.
...
> # Test Architecture
> **Project:** KnowledgeOS  
> **Section:** Code Architecture / Testing  
> **Document:** TestArchitecture  
> **Version:** 5.0  
> **Status:** Release Candidate  
> **Author:** KnowledgeOS Team  
> ---
> Testing layers are unit, component, repository integration, provider contract, API contract, migration, architecture, end-to-end, performance, recovery and security. Cross-language fixtures verify Swift and TypeScript serialize the same logical contracts. Tests SHALL include failure paths and offline behavior.
