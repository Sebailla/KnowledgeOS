        # Infraestructura PostgreSQL — Module Specification
        ...
        **Last updated:** 2026-08-02
        ...
        Define persistencia relacional, migraciones, transacciones, outbox y adaptadores del driver PostgreSQL.
        ...
        | Package | Role |
        |---|---|
        | `packages/infrastructure-postgres` | Implementación o contratos asociados a Infraestructura PostgreSQL. |
| `packages/infrastructure-postgres-node` | Implementación o contratos asociados a Infraestructura PostgreSQL. |
