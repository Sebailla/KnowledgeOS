...
**Document:** `TransactionsAndOutbox.md`  
...
- Las migraciones son monotónicas, auditables y compatibles con despliegues progresivos.
- Las transacciones agrupan cambios de estado y outbox cuando la consistencia entre datos y eventos lo exige.
...
> # Transactions and Outbox
> Application composition SHALL use a single PostgreSQL transaction for:
> - aggregate writes;
> - Local Library membership changes;
> - acquisition state;
> - outbox event insertion.
> Events are published after commit. Duplicate event insertion is prevented by stable event identity.
