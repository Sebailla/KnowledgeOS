...
**Document:** `PersistenceBoundary.md`  
...
> # Persistence Boundary
> PostgreSQL stores serialized aggregate snapshots and operational outbox records.
> The database does not define Domain identity, authority or lifecycle semantics. Those remain in `@knowledgeos/domain`.
