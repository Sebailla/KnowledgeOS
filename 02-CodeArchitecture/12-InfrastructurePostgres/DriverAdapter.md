...
> # Driver Adapter
> The package intentionally defines a small `SqlDatabase` abstraction.
> A later adapter may implement it using `postgres`, `pg` or another approved driver without changing Domain or Platform packages.
