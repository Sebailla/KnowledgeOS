...
- defining a typed and owner-scoped representation of context selection, offsets, highlighting, format safety, and reproducibility;
...
The normative flow for context selection, offsets, highlighting, format safety, and reproducibility is:
...
Results include highlighted snippets generated by FTS5.

Snippet generation does not modify canonical text.
