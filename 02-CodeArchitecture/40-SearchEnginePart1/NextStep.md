...
- defining a typed and owner-scoped representation of implemented boundary, intentionally deferred capabilities, prerequisites, and compatibility constraints;
...
The normative flow for implemented boundary, intentionally deferred capabilities, prerequisites, and compatibility constraints is:
...
Search Engine Part 2 will add the query language, field filters, phrases, boolean operators, fuzzy terms and faceted result contracts.
