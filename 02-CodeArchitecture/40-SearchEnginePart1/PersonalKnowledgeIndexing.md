...
**Document:** Personal Knowledge Indexing  
...
- defining a typed and owner-scoped representation of search document projection, incremental index mutations, invalidation, and consistency;
...
The normative flow for search document projection, incremental index mutations, invalidation, and consistency is:
...
Notes, highlights, annotations and bookmarks are projected as independent Search Documents.

They remain linked to their Knowledge Object and separate from publication bytes.
