...
- defining a typed and owner-scoped representation of Unicode normalization, token boundaries, case folding, language handling, and deterministic indexing;
...
The normative flow for Unicode normalization, token boundaries, case folding, language handling, and deterministic indexing is:
...
Text uses Unicode NFKC normalization, whitespace compaction and deterministic term deduplication.

The canonical document preserves original semantic fields while exposing normalized searchable text.
