...
- defining a typed and owner-scoped representation of offline behavior, local availability, deferred work, and reconnection guarantees;
...
The normative flow for offline behavior, local availability, deferred work, and reconnection guarantees is:
...
The FTS index is stored locally and can be queried without the NAS, remote AI or network connectivity.
