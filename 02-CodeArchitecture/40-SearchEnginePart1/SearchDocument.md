...
- defining a typed and owner-scoped representation of canonical searchable projection, source identity, fields, metadata, and versioning;
...
The normative flow for canonical searchable projection, source identity, fields, metadata, and versioning is:
...
A Search Document is a normalized projection of searchable content.
