# S Q Lite Graph Storage

**Project:** KnowledgeOS  
**Section:** `02-CodeArchitecture/45-SearchEnginePart6`  
**Document:** S Q Lite Graph Storage  
...
- defining a typed and owner-scoped representation of graph projection, traversal budgets, relationship filtering, ranking, and explanation;
...
The normative flow for graph projection, traversal budgets, relationship filtering, ranking, and explanation is:
...
Nodes and edges are stored separately with indexes on source, target and relationship type.
