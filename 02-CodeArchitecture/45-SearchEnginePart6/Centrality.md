...
- defining a typed and owner-scoped representation of centrality signals, bounded contribution, graph scope, computation, and ranking;
...
The normative flow for centrality signals, bounded contribution, graph scope, computation, and ranking is:
...
Initial centrality signals:

- degree;
- weighted degree.

These signals are deterministic and inexpensive for local graphs.
