...
- defining a typed and owner-scoped representation of lexical and semantic result fusion, missing stages, weighting, and fallback;
...
The normative flow for lexical and semantic result fusion, missing stages, weighting, and fallback is:
