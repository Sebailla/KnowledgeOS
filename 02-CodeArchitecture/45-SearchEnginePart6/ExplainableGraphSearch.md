# Explainable Graph Search

**Project:** KnowledgeOS  
**Section:** `02-CodeArchitecture/45-SearchEnginePart6`  
**Document:** Explainable Graph Search  
...
- defining a typed and owner-scoped representation of score decomposition, provenance, stage timing, and user-facing diagnostics;
...
The normative flow for score decomposition, provenance, stage timing, and user-facing diagnostics is:
...
The UI can show why a result was returned.
