...
- defining a typed and owner-scoped representation of neighbor expansion depth, direction, relationship types, fan-out limits, and cycles;
...
The normative flow for neighbor expansion depth, direction, relationship types, fan-out limits, and cycles is:
...
- `packages/search-api`
- `packages/knowledge-graph-traversal`
...
Base search candidates become graph seeds.

Related nodes can enter the result set even when they have no direct lexical or vector match.
