...
- defining a typed and owner-scoped representation of path search constraints, scoring, maximum depth, cycle prevention, and explanations;
...
The normative flow for path search constraints, scoring, maximum depth, cycle prevention, and explanations is:
...
The initial path service returns the shortest unweighted path within a configured maximum depth and records accumulated edge weight.
