...
**Project:** KnowledgeOS  
**Section:** Code Architecture / 28-LocalLibraryPart1  
**Document:** PersonalKnowledgeBoundary  
**Version:** 5.6.2  
**Status:** Consolidated  
**Implemented by:** `packages/local-library`  
**Last updated:** 2026-08-02

---
## 1. Propósito

Este documento desarrolla **contratos, invariantes, flujo operacional y relación con el resto del subsistema** dentro de núcleo de biblioteca local. No redefine la visión del producto ni sustituye los ADR; traduce esas decisiones a reglas implementables y verificables para define manifest, adquisición, acceso offline, integridad y frontera con conocimiento personal.
...
Núcleo de biblioteca local se ubica entre los contratos de dominio y los adaptadores operativos. Sus consumidores no deben depender de tablas, rutas físicas ni implementaciones concretas. La dirección de dependencia es desde adaptadores hacia contratos estables.
...
La implementación reside principalmente en `packages/local-library`. La separación recomendada distingue: contratos y modelos; servicio de aplicación; puertos de repositorio o transporte; adaptadores de infraestructura; composición productiva; y pruebas de integración.
...
**Implementación principal:** `packages/local-library`.

**Documentación rectora:** `02-CodeArchitecture/28-LocalLibraryPart1/ModuleSpecification.md`.
...
Annotations, highlights and notes are not stored inside Local Publication Records or publication bytes.

They will use the dedicated Personal Knowledge subsystem.
