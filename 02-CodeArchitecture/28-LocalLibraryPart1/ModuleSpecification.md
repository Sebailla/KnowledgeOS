...
Núcleo de biblioteca local existe para define manifest, adquisición, acceso offline, integridad y frontera con conocimiento personal. Esta especificación gobierna sus documentos subordinados y la implementación ubicada en `packages/local-library`.
