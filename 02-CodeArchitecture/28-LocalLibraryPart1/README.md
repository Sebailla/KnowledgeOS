...
Este documento desarrolla **visión rectora, límites, dependencias y mapa de lectura del módulo** dentro de núcleo de biblioteca local. No redefine la visión del producto ni sustituye los ADR; traduce esas decisiones a reglas implementables y verificables para define manifest, adquisición, acceso offline, integridad y frontera con conocimiento personal.
...
# Local Library — Part 1

**Project:** KnowledgeOS  
**Section:** Code Architecture / Local Library  
**Version:** 5.0  
**Status:** Release Candidate  

This block establishes the Local Library as the offline working copy of canonical publications.
