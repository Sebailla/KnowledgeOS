...
Este documento desarrolla **estrategia de pruebas, fixtures, propiedades, fallos y criterios de aceptación** dentro de API de la Master Library. No redefine la visión del producto ni sustituye los ADR; traduce esas decisiones a reglas implementables y verificables para expone registro, consulta y descarga con límites de seguridad y contratos estables.
...
- version listing;
- content download;
- checksum-verified storage read.
