...
Api de la master library existe para expone registro, consulta y descarga con límites de seguridad y contratos estables. Esta especificación gobierna sus documentos subordinados y la implementación ubicada en `packages/master-library-api`.
