...
Este documento desarrolla **visión rectora, límites, dependencias y mapa de lectura del módulo** dentro de API de la Master Library. No redefine la visión del producto ni sustituye los ADR; traduce esas decisiones a reglas implementables y verificables para expone registro, consulta y descarga con límites de seguridad y contratos estables.
...
**Project:** KnowledgeOS  
**Section:** Code Architecture / Master Library API  
**Version:** 5.0  
**Status:** Release Candidate  

This block exposes the authoritative Master Library through an HTTP application boundary.
