...
**Project:** KnowledgeOS  
**Section:** `02-CodeArchitecture/08-FoundationalContracts`  
**Document:** `ContractNamespaces.md`  
**Documentation version:** 5.6.1  
**Status:** Consolidated  
**Last updated:** 2026-08-02  
**Implemented by:** `packages/contracts`, `packages/domain-types`

## 1. Purpose

El tema **Contract Namespaces** se interpreta dentro de Contratos fundacionales y debe conservar límites explícitos, semántica determinista y trazabilidad. Establece la razón de existencia del documento y la decisión de ingeniería que gobierna. Este documento convierte una descripción breve en una especificación verificable y mantiene la terminología de KnowledgeOS.

## 2. Scope

Cubre **Contract Namespaces** dentro de **Contratos fundacionales**. Define namespaces, evolución, validación y frontera de generación Swift de los contratos base. Delimita los componentes, flujos y consumidores cubiertos, evitando convertir el documento en una descripción global del producto. No redefine Product Vision, arquitectura de dominio global ni políticas operativas pertenecientes a otros directorios.
...
> # Contract Namespaces
> Contract type strings use stable namespaces:
> - `library.*`
> - `reading.*`
> - `annotation.*`
> - `search.*`
...
> - `plugin.*`
> - `export.*`
> Adding an optional contract is minor-version compatible. Changing required semantics is a major-version change.
