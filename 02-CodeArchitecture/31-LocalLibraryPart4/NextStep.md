...
Local Library Part 5 will add filesystem-backed resumable staging, SQLite transfer descriptors/checkpoints and the complete production composition between Master direct streaming and Local Library.
