...
**Document:** Master Source Contract  
...
- defining a typed and owner-scoped representation of contract with the authoritative Master Library and the conditions required before local acknowledgement;
...
The normative flow for contract with the authoritative Master Library and the conditions required before local acknowledgement is:
...
The source exposes immutable publication-version metadata and inclusive byte-range reads.

A changed fingerprint or byte length invalidates the planned transfer.
