...
Este documento desarrolla **estrategia de pruebas, fixtures, propiedades, fallos y criterios de aceptación** dentro de workflow de registro autoritativo. No redefine la visión del producto ni sustituye los ADR; traduce esas decisiones a reglas implementables y verificables para coordina almacenamiento y catálogo con atomicidad lógica, outbox, deduplicación y compensación.
...
- stage and commit;
- Master Library registration;
- storage catalog;
- outbox event sink contract;
- duplicate detection;
