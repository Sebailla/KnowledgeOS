...
The next block is the Master Library API and server composition:

- multipart or streamed upload boundary;
- publication registration endpoint;
- version endpoint;
- metadata queries;
- secure source download;
- PostgreSQL and NAS runtime composition.
