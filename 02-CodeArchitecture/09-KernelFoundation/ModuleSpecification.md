# Kernel de ejecución — Module Specification
...
Define buses de comandos, consultas y eventos, contexto de ejecución, idempotencia y reintentos.
...
| Package | Role |
|---|---|
| `packages/kernel` | Implementación o contratos asociados a Kernel de ejecución. |
