...
**Project:** KnowledgeOS  
**Section:** `02-CodeArchitecture/09-KernelFoundation`  
**Document:** `ExecutionContext.md`  
**Documentation version:** 5.6.1  
**Status:** Consolidated  
**Last updated:** 2026-08-02  
**Implemented by:** `packages/kernel`

## 1. Purpose

El tema **Execution Context** se interpreta dentro de Kernel de ejecución y debe conservar límites explícitos, semántica determinista y trazabilidad. Establece la razón de existencia del documento y la decisión de ingeniería que gobierna. Este documento convierte una descripción breve en una especificación verificable y mantiene la terminología de KnowledgeOS.

## 2. Scope

Cubre **Execution Context** dentro de **Kernel de ejecución**. Define buses de comandos, consultas y eventos, contexto de ejecución, idempotencia y reintentos. Delimita los componentes, flujos y consumidores cubiertos, evitando convertir el documento en una descripción global del producto. No redefine Product Vision, arquitectura de dominio global ni políticas operativas pertenecientes a otros directorios.
...
> # Execution Context
> Execution context carries operation, correlation, actor, privacy, clock, cancellation and bounded metadata.
> It is passed explicitly. Kernel code SHALL NOT depend on hidden global request state.
