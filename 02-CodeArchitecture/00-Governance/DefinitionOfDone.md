...
**Project:** KnowledgeOS  
**Section:** `02-CodeArchitecture/00-Governance`  
**Document:** `DefinitionOfDone.md`  
**Documentation version:** 5.6.1  
**Status:** Consolidated  
**Last updated:** 2026-08-02  
**Implemented by:** `packages/tooling`, `packages/testing`

## 1. Purpose

El tema **Definition of Done** se interpreta dentro de Gobernanza de arquitectura de código y debe conservar límites explícitos, semántica determinista y trazabilidad. Establece la razón de existencia del documento y la decisión de ingeniería que gobierna. Este documento convierte una descripción breve en una especificación verificable y mantiene la terminología de KnowledgeOS.

## 2. Scope

Cubre **Definition of Done** dentro de **Gobernanza de arquitectura de código**. Define principios, criterios de aceptación, nomenclatura y controles que gobiernan toda decisión de implementación. Delimita los componentes, flujos y consumidores cubiertos, evitando convertir el documento en una descripción global del producto. No redefine Product Vision, arquitectura de dominio global ni políticas operativas pertenecientes a otros directorios.
...
Application Contract
        │
        ▼
Gobernanza de arquitectura de código
        │
        ▼
...
La implementación concreta puede evolucionar siempre que mantenga los contratos, invariantes y evidencias descritos aquí. Los conceptos deben identificarse mediante nombres estables, datos inmutables cuando representan hechos y versiones explícitas cuando forman parte de un contrato persistente. La identidad lógica se mantiene separada de hashes, ubicaciones físicas y representaciones de transporte.
...
- La implementación concreta puede evolucionar siempre que mantenga los contratos, invariantes y evidencias descritos aquí.
...
> # Code Architecture Definition of Done
> **Project:** KnowledgeOS  
...
> ---
> A package or application is complete when its public API, dependencies, tests, build, generated artifacts, migration impact, observability and V4 traceability are documented and validated. Forbidden imports, unversioned contracts, handwritten generated types, unresolved placeholders and undocumented persistent changes block completion.
