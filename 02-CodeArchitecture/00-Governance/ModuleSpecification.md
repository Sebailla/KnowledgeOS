        # Gobernanza de arquitectura de código — Module Specification
        ...
        **Last updated:** 2026-08-02
        ...
        Define principios, criterios de aceptación, nomenclatura y controles que gobiernan toda decisión de implementación.
        ...
        | Package | Role |
        |---|---|
        | `packages/tooling` | Implementación o contratos asociados a Gobernanza de arquitectura de código. |
| `packages/testing` | Implementación o contratos asociados a Gobernanza de arquitectura de código. |
