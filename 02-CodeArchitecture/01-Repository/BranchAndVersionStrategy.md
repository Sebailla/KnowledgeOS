...
**Document:** `BranchAndVersionStrategy.md`  
...
El monorepo es la unidad de integración y permite cambios atómicos entre contratos, implementación y pruebas. Establece la razón de existencia del documento y la decisión de ingeniería que gobierna. Este documento convierte una descripción breve en una especificación verificable y mantiene la terminología de KnowledgeOS.

## 2. Scope

Cubre **Branch and Version Strategy** dentro de **Estrategia del repositorio**. Define la organización del monorepo, el ciclo de versiones, los artefactos generados y las reglas de workspace. Delimita los componentes, flujos y consumidores cubiertos, evitando convertir el documento en una descripción global del producto. No redefine Product Vision, arquitectura de dominio global ni políticas operativas pertenecientes a otros directorios.
...
- Los artefactos generados deben ser reproducibles y no convertirse en una fuente autoritativa paralela.
...
> **Document:** BranchAndVersionStrategy  
> **Version:** 5.0  
> **Status:** Release Candidate  
> **Author:** KnowledgeOS Team  
> ---
> Use short-lived branches, protected main, changesets for publishable TypeScript packages and explicit application versions for Apple targets. Contract schema versions are independent of package versions. Breaking wire changes require a major contract version and compatibility plan.
