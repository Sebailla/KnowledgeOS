...
**Project:** KnowledgeOS  
**Section:** `02-CodeArchitecture/01-Repository`  
**Document:** `GeneratedArtifacts.md`  
**Documentation version:** 5.6.1  
**Status:** Consolidated  
**Last updated:** 2026-08-02  
**Implemented by:** `packages/tooling`

## 1. Purpose

El tema **Generated Artifacts** se interpreta dentro de Estrategia del repositorio y debe conservar límites explícitos, semántica determinista y trazabilidad. Establece la razón de existencia del documento y la decisión de ingeniería que gobierna. Este documento convierte una descripción breve en una especificación verificable y mantiene la terminología de KnowledgeOS.

## 2. Scope

Cubre **Generated Artifacts** dentro de **Estrategia del repositorio**. Define la organización del monorepo, el ciclo de versiones, los artefactos generados y las reglas de workspace. Delimita los componentes, flujos y consumidores cubiertos, evitando convertir el documento en una descripción global del producto. No redefine Product Vision, arquitectura de dominio global ni políticas operativas pertenecientes a otros directorios.
...
> ---
> Generated artifacts include OpenAPI clients, JSON Schema validators, event type registries and Swift/TypeScript wire models. Inputs live under `packages/contracts/schemas`. Outputs live under package-specific `generated/` directories and include provenance headers. CI regenerates and fails on drift.
