# Estrategia del repositorio — Module Specification
...
Define la organización del monorepo, el ciclo de versiones, los artefactos generados y las reglas de workspace.
...
| Package | Role |
|---|---|
| `packages/tooling` | Implementación o contratos asociados a Estrategia del repositorio. |
