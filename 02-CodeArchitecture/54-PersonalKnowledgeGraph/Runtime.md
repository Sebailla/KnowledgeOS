...
**Project:** KnowledgeOS  
**Code Architecture module:** `54-PersonalKnowledgeGraph`  
**Subsystem:** PersonalKnowledge  
**Documentation version:** 5.6.4  
**Status:** Consolidated  
**Implemented by:** `packages/personal-knowledge`, `packages/personal-knowledge-anchor`, `packages/personal-knowledge-anchor-sqlite`, `packages/personal-knowledge-auth`, `packages/personal-knowledge-conflict-resolution`, `packages/personal-knowledge-events`, `packages/personal-knowledge-graph`, `packages/personal-knowledge-graph-runtime`, `packages/personal-knowledge-graph-sqlite`, `packages/personal-knowledge-integration`, `packages/personal-knowledge-sqlite`, `packages/personal-knowledge-sync`

## Executive specification

This document governs the **Runtime** concern within the PersonalKnowledge subsystem. It narrows the module-wide guarantees to the contracts, state, algorithms, and operational boundaries implied by this concern. The runtime follows the canonical pipeline: capture explicit or inferred signal → validate provenance and confidence → persist personal item → emit event → project to Knowledge Graph and Search → synchronize by cursor. Startup validates configuration and dependencies before accepting work; shutdown stops new work, drains bounded in-flight operations, persists durable checkpoints, and releases leases.
...
- Related packages: `packages/personal-knowledge`, `packages/personal-knowledge-anchor`, `packages/personal-knowledge-anchor-sqlite`, `packages/personal-knowledge-auth`, `packages/personal-knowledge-conflict-resolution`, `packages/personal-knowledge-events`, `packages/personal-knowledge-graph`, `packages/personal-knowledge-graph-runtime`, `packages/personal-knowledge-graph-sqlite`, `packages/personal-knowledge-integration`, `packages/personal-knowledge-sqlite`, `packages/personal-knowledge-sync`
...
Valida invariantes, persiste cambios, emite eventos y produce contexto ordenado por relevancia.
