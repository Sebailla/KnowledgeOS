...
Este documento desarrolla **identidad de contenido, verificación, deduplicación e inconsistencias detectables** dentro de almacenamiento autoritativo de archivos. No redefine la visión del producto ni sustituye los ADR; traduce esas decisiones a reglas implementables y verificables para controla staging, commit, layout, integridad, recuperación y objetos huérfanos.
...
Every read recalculates SHA-256 and compares it with the catalog fingerprint.

Fingerprint conflicts block commit. Corrupt objects are not returned as valid publication content.
