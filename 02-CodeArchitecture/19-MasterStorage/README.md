...
Este documento desarrolla **visión rectora, límites, dependencias y mapa de lectura del módulo** dentro de almacenamiento autoritativo de archivos. No redefine la visión del producto ni sustituye los ADR; traduce esas decisiones a reglas implementables y verificables para controla staging, commit, layout, integridad, recuperación y objetos huérfanos.
...
**Project:** KnowledgeOS  
**Section:** Code Architecture / Master Storage  
**Version:** 5.0  
**Status:** Release Candidate  

This block implements the authoritative publication-files volume.
