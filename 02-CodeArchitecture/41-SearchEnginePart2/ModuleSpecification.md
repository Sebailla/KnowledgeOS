# Module Specification — 41-SearchEnginePart2
...
- `BooleanOperators.md` — operator precedence, associativity, AST representation, validation, and SQL compilation.
- `DateRanges.md` — date parsing, inclusive/exclusive boundaries, timezone normalization, and index use.
- `Facets.md` — facet collection, filters, counts, pagination interaction, and performance.
- `FieldQueries.md` — field names, typing, validation, allowed operators, and query compilation.
- `NextStep.md` — implemented boundary, intentionally deferred capabilities, prerequisites, and compatibility constraints.
- `Pagination.md` — stable ordering, offsets or cursors, result consistency, and maximum limits.
- `PhraseAndPrefix.md` — phrase and prefix semantics, escaping, tokenization, and FTS compilation.
- `QueryCompilation.md` — query language grammar, parsing, validation, canonical AST, and execution planning.
- `QueryLanguage.md` — query language grammar, parsing, validation, canonical AST, and execution planning.
