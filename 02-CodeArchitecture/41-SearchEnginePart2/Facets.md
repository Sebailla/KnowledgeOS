...
- defining a typed and owner-scoped representation of facet collection, filters, counts, pagination interaction, and performance;
...
The normative flow for facet collection, filters, counts, pagination interaction, and performance is:
...
Buckets contain a value and result count.
