...
- defining a typed and owner-scoped representation of field names, typing, validation, allowed operators, and query compilation;
...
The normative flow for field names, typing, validation, allowed operators, and query compilation is:
