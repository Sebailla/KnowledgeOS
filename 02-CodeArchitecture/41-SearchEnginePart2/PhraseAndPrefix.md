...
- defining a typed and owner-scoped representation of phrase and prefix semantics, escaping, tokenization, and FTS compilation;
...
The normative flow for phrase and prefix semantics, escaping, tokenization, and FTS compilation is:
...
Quoted values compile as exact FTS phrases.

Terms ending in `*` compile as FTS prefix queries.
