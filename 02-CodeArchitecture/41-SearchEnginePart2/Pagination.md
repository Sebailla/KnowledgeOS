...
- defining a typed and owner-scoped representation of stable ordering, offsets or cursors, result consistency, and maximum limits;
...
The normative flow for stable ordering, offsets or cursors, result consistency, and maximum limits is:
...
Queries carry explicit `limit` and `offset`.

The reader returns total matches independently from the current page.
