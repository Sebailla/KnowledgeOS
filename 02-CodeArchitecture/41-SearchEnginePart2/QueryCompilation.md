...
- defining a typed and owner-scoped representation of query language grammar, parsing, validation, canonical AST, and execution planning;
...
The normative flow for query language grammar, parsing, validation, canonical AST, and execution planning is:
...
User values are never concatenated into relational SQL.
