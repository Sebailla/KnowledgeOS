# Aplicaciones y hosts — Module Specification
...
Describe los hosts macOS, iOS, iPadOS, Web y servidor, sus límites y su relación con los paquetes compartidos.
...
| Package | Role |
|---|---|
| `packages/client-sdk` | Implementación o contratos asociados a Aplicaciones y hosts. |
