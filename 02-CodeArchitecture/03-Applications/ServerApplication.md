...
Cubre **Server Application** dentro de **Aplicaciones y hosts**. Describe los hosts macOS, iOS, iPadOS, Web y servidor, sus límites y su relación con los paquetes compartidos. Delimita los componentes, flujos y consumidores cubiertos, evitando convertir el documento en una descripción global del producto. No redefine Product Vision, arquitectura de dominio global ni políticas operativas pertenecientes a otros directorios.
