        # Reglas de dependencias — Module Specification
        ...
        **Last updated:** 2026-08-02
        ...
        Define la dirección permitida de dependencias, visibilidad modular, contratos entre lenguajes y prohibiciones arquitectónicas.
        ...
        | Package | Role |
        |---|---|
        | `packages/contracts` | Implementación o contratos asociados a Reglas de dependencias. |
| `packages/domain-types` | Implementación o contratos asociados a Reglas de dependencias. |
| `packages/kernel` | Implementación o contratos asociados a Reglas de dependencias. |
