...
Every response chunk checks `ServerResponse.write()`.

When the writable buffer is full, the server waits for `drain` before reading and forwarding more data.
