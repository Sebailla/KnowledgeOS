...
Streaming directo de archivos existe para transfiere contenido desde el almacenamiento sin materialización completa en memoria. Esta especificación gobierna sus documentos subordinados y la implementación ubicada en `packages/master-direct-file-streaming`.
