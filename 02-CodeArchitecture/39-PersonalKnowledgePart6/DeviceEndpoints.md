...
- defining a typed and owner-scoped representation of device identity, registration, revocation, replica state, and cursor isolation;
...
The normative flow for device identity, registration, revocation, replica state, and cursor isolation is:
...
- `POST /v1/personal-knowledge/devices`
- `GET /v1/personal-knowledge/devices`
- `DELETE /v1/personal-knowledge/devices/{deviceId}`

A device may register only its own authenticated identity.
