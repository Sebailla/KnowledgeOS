...
- defining a typed and owner-scoped representation of event schema, monotonic ordering, persistence, delivery, replay, and audit;
...
The normative flow for event schema, monotonic ordering, persistence, delivery, replay, and audit is:
...
- `POST /v1/personal-knowledge/events`
- `GET /v1/personal-knowledge/events?after={cursor}&limit={limit}`

The runtime enforces owner isolation and active-device status.
