...
- defining a typed and owner-scoped representation of conflict detection, persistence, automatic and manual resolution, audit, and atomicity;
...
The normative flow for conflict detection, persistence, automatic and manual resolution, audit, and atomicity is:
...
- `GET /v1/personal-knowledge/conflicts`
- `POST /v1/personal-knowledge/conflicts/{conflictId}/resolve`

Resolution emits a new synchronization event.
