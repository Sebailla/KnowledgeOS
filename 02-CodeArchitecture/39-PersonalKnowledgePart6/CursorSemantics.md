...
- defining a typed and owner-scoped representation of monotonic cursors, source/target scope, acknowledgement, rewind prohibition, and recovery;
...
The normative flow for monotonic cursors, source/target scope, acknowledgement, rewind prohibition, and recovery is:
...
Cursors are monotonic and owner-scoped.

Each device persists its acknowledged cursor independently.
