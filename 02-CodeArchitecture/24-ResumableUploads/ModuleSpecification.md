...
Protocolo de cargas reanudables existe para define sesiones, chunks, finalización, durabilidad, limpieza y reanudación idempotente. Esta especificación gobierna sus documentos subordinados y la implementación ubicada en `packages/resumable-uploads`.
