...
Este documento desarrolla **visión rectora, límites, dependencias y mapa de lectura del módulo** dentro de protocolo de cargas reanudables. No redefine la visión del producto ni sustituye los ADR; traduce esas decisiones a reglas implementables y verificables para define sesiones, chunks, finalización, durabilidad, limpieza y reanudación idempotente.
...
**Project:** KnowledgeOS  
**Section:** Code Architecture / Resumable Uploads  
**Version:** 5.0  
**Status:** Release Candidate  

This block supports large uploads over unreliable networks.
