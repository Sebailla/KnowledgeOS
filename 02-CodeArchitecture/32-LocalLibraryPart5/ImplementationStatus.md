# Implementation Status — 32-LocalLibraryPart5
...
- `packages/local-library` — present in the repository and included in architectural traceability.
- `packages/local-library-sqlite` — present in the repository and included in architectural traceability.
- `packages/local-storage` — present in the repository and included in architectural traceability.
- `packages/local-cache` — present in the repository and included in architectural traceability.
- `packages/local-maintenance` — present in the repository and included in architectural traceability.
- `packages/local-repair` — present in the repository and included in architectural traceability.
- `packages/sync-local-runtime` — present in the repository and included in architectural traceability.
- `packages/sync-local-sqlite` — present in the repository and included in architectural traceability.
