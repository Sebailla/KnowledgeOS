        # Catálogo de paquetes — Module Specification
        ...
        **Last updated:** 2026-08-02
        ...
        Documenta las responsabilidades de los paquetes públicos y privados del monorepo y su ubicación en las capas arquitectónicas.
        ...
        | Package | Role |
        |---|---|
        | `packages/contracts` | Implementación o contratos asociados a Catálogo de paquetes. |
| `packages/domain-types` | Implementación o contratos asociados a Catálogo de paquetes. |
| `packages/kernel` | Implementación o contratos asociados a Catálogo de paquetes. |
| `packages/library` | Implementación o contratos asociados a Catálogo de paquetes. |
| `packages/search` | Implementación o contratos asociados a Catálogo de paquetes. |
| `packages/sync` | Implementación o contratos asociados a Catálogo de paquetes. |
| `packages/ai` | Implementación o contratos asociados a Catálogo de paquetes. |
| `packages/plugin-sdk` | Implementación o contratos asociados a Catálogo de paquetes. |
