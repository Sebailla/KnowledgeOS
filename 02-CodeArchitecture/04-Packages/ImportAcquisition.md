...
**Project:** KnowledgeOS  
**Section:** `02-CodeArchitecture/04-Packages`  
**Document:** `ImportAcquisition.md`  
**Documentation version:** 5.6.1  
**Status:** Consolidated  
**Last updated:** 2026-08-02  
**Implemented by:** `packages/contracts`, `packages/domain-types`, `packages/kernel`, `packages/library`, `packages/search`, `packages/sync`, `packages/ai`, `packages/plugin-sdk`

## 1. Purpose

El tema **Import Acquisition** se interpreta dentro de Catálogo de paquetes y debe conservar límites explícitos, semántica determinista y trazabilidad. Establece la razón de existencia del documento y la decisión de ingeniería que gobierna. Este documento convierte una descripción breve en una especificación verificable y mantiene la terminología de KnowledgeOS.

## 2. Scope

Cubre **Import Acquisition** dentro de **Catálogo de paquetes**. Documenta las responsabilidades de los paquetes públicos y privados del monorepo y su ubicación en las capas arquitectónicas. Delimita los componentes, flujos y consumidores cubiertos, evitando convertir el documento en una descripción global del producto. No redefine Product Vision, arquitectura de dominio global ni políticas operativas pertenecientes a otros directorios.
...
> # ImportAcquisition Package
> **Project:** KnowledgeOS  
> **Section:** Code Architecture / Packages  
> **Document:** ImportAcquisition  
> **Version:** 5.0  
> **Status:** Release Candidate  
> **Author:** KnowledgeOS Team  
> ---
> ## Responsibility
> Discovery, import and explicit acquisition orchestration contracts.
> ## Public API
