...
- Los agregados limitan el alcance transaccional y evitan escrituras parciales inconsistentes.
...
> ---
> ## Responsibility
> Projection and graph query public APIs; graph stores remain adapters.
> ## Public API
