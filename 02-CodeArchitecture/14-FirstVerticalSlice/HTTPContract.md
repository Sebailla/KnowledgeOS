...
> ## List Local Library
> `GET /v1/library/local-library?localLibraryId=...&limit=...`
> ## Resolve availability
> `GET /v1/library/local-availability?localLibraryId=...&knowledgeObjectId=...`
> HTTP remains an adapter over versioned KnowledgeOS Commands and Queries.
