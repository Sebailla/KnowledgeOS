...
> The fixture executes against compiled JavaScript artifacts.
> Workspace package links are created only in the temporary validation environment. The ZIP does not include `node_modules`.
> The test verifies public package exports and the complete in-memory application composition.
