...
- defining a typed and owner-scoped representation of batch sizing, memory limits, transaction boundaries, partial failures, and retries;
...
The normative flow for batch sizing, memory limits, transaction boundaries, partial failures, and retries is:
...
Workers lease ordered batches by model, priority and creation time.
