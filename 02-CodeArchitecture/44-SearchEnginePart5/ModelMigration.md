...
- defining a typed and owner-scoped representation of model migration planning, dual-read or rebuild behavior, progress, rollback, and compatibility;
...
The normative flow for model migration planning, dual-read or rebuild behavior, progress, rollback, and compatibility is:
...
A model migration can remove embeddings from the previous model and enqueue high-priority jobs for the replacement model.
