...
- defining a typed and owner-scoped representation of worker ownership, leases, cancellation, heartbeat, and hand-off between runtime phases;
...
The normative flow for worker ownership, leases, cancellation, heartbeat, and hand-off between runtime phases is:
