...
**Document:** Background Reindexing  
...
Reindexing does not block lexical search.

Hybrid search can continue using available vectors while the new model is populated.
