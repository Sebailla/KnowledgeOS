...
- defining a typed and owner-scoped representation of lease acquisition, renewal, expiry, ownership, clock assumptions, and recovery;
...
The normative flow for lease acquisition, renewal, expiry, ownership, clock assumptions, and recovery is:
...
Jobs move from queued to running under a lease ID and expiration timestamp.

This prevents concurrent workers from processing the same queued job.
