...
- defining a typed and owner-scoped representation of replica manifest contents, compatibility, validation, and reconciliation;
...
The normative flow for replica manifest contents, compatibility, validation, and reconciliation is:
...
Personal Knowledge manifests are independent from canonical publication manifests.
