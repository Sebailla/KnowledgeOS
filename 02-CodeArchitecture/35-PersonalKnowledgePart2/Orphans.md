...
- defining a typed and owner-scoped representation of unresolved references, quarantine, repair, retention, and user-visible diagnostics;
...
The normative flow for unresolved references, quarantine, repair, retention, and user-visible diagnostics is:
...
Unresolved anchors remain stored and recoverable.
