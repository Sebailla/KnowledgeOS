# Module Specification — 36-PersonalKnowledgePart3
...
- `AutomaticMerge.md` — the automatic merge concern within the Personal Knowledge subsystem, including contracts, invariants, runtime behavior, persistence, failure handling, and verification.
- `BidirectionalSync.md` — incremental exchange, envelopes, cursors, acknowledgements, conflicts, and replay safety.
- `ConflictPersistence.md` — conflict detection, persistence, automatic and manual resolution, audit, and atomicity.
- `DeviceReplicas.md` — device identity, registration, revocation, replica state, and cursor isolation.
- `Isolation.md` — separation between canonical shared knowledge and owner-specific personal projections.
...
- `RevisionVectors.md` — revision vectors, version comparison, causality, and merge preconditions.
- `SyncEnvelope.md` — incremental exchange, envelopes, cursors, acknowledgements, conflicts, and replay safety.
- `Testing.md` — unit, integration, property, failure-injection, persistence, concurrency, and end-to-end verification.
- `Tombstones.md` — deletion facts, dominance rules, propagation, retention, and compaction.
