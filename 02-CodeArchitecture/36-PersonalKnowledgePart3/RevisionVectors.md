...
Each item replica stores a counter per device.

Vector comparison determines whether one replica is before, after, equal to or concurrent with another.
