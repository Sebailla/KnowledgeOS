...
- defining a typed and owner-scoped representation of deletion facts, dominance rules, propagation, retention, and compaction;
...
The normative flow for deletion facts, dominance rules, propagation, retention, and compaction is:
...
Soft-deleted items propagate as tombstones.

A concurrent deletion wins over a live edit in the initial deterministic policy, while revision history remains available.
