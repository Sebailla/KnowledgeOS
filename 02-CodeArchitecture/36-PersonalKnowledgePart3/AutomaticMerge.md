...
- defining a typed and owner-scoped representation of the automatic merge concern within the Personal Knowledge subsystem, including contracts, invariants, runtime behavior, persistence, failure handling, and verification;
...
The normative flow for the automatic merge concern within the Personal Knowledge subsystem, including contracts, invariants, runtime behavior, persistence, failure handling, and verification is:
...
Concurrent changes merge automatically when they affect independent fields.

Tags are unioned deterministically. Body or anchor edits that diverge on both replicas create a conflict.
