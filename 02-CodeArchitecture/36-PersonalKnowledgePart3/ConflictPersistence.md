...
Conflicts store base revision, local snapshot, remote snapshot, state and timestamps.

They remain open until an explicit resolution workflow records `resolvedAt`.
