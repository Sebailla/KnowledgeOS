...
Devices exchange owner-scoped envelopes containing complete item replicas and revision vectors.

Canonical publication synchronization remains a separate one-way flow.
