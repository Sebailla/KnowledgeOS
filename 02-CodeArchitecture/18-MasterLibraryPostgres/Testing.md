...
Este documento desarrolla **estrategia de pruebas, fixtures, propiedades, fallos y criterios de aceptación** dentro de persistencia PostgreSQL de la Master Library. No redefine la visión del producto ni sustituye los ADR; traduce esas decisiones a reglas implementables y verificables para mapea agregados y repositorios del dominio a un esquema transaccional e indexado.
...
- publication upsert SQL;
- version upsert SQL;
- fingerprint lookup;
- repository row mapping.

A real PostgreSQL container test remains part of CI.
