...
Este documento desarrolla **visión rectora, límites, dependencias y mapa de lectura del módulo** dentro de persistencia PostgreSQL de la Master Library. No redefine la visión del producto ni sustituye los ADR; traduce esas decisiones a reglas implementables y verificables para mapea agregados y repositorios del dominio a un esquema transaccional e indexado.
...
# Master Library PostgreSQL

**Project:** KnowledgeOS  
**Section:** Code Architecture / Master Library PostgreSQL  
**Version:** 5.0  
**Status:** Release Candidate  

This block persists Master Library catalog state in PostgreSQL.
