...
Persistencia postgresql de la master library existe para mapea agregados y repositorios del dominio a un esquema transaccional e indexado. Esta especificación gobierna sus documentos subordinados y la implementación ubicada en `packages/master-library-postgres`.
