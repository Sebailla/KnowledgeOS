...
Este documento desarrolla **unidad de trabajo, concurrencia, commit, rollback lógico y eventos derivados** dentro de persistencia PostgreSQL de la Master Library. No redefine la visión del producto ni sustituye los ADR; traduce esas decisiones a reglas implementables y verificables para mapea agregados y repositorios del dominio a un esquema transaccional e indexado.
...
Registration of a publication and first version SHALL execute in one Unit of Work.

The fingerprint uniqueness constraint provides the final concurrency boundary for deduplication.
