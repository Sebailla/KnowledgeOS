...
Este documento desarrolla **contratos, invariantes, flujo operacional y relación con el resto del subsistema** dentro de persistencia PostgreSQL de la Master Library. No redefine la visión del producto ni sustituye los ADR; traduce esas decisiones a reglas implementables y verificables para mapea agregados y repositorios del dominio a un esquema transaccional e indexado.
...
The next block will implement authoritative source-file storage on the NAS:
...
- staging and commit;
- orphan detection;
- integration with Master Library registration.
