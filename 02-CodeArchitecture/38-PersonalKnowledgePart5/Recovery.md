...
- defining a typed and owner-scoped representation of the recovery concern within the Personal Knowledge subsystem, including contracts, invariants, runtime behavior, persistence, failure handling, and verification;
...
The normative flow for the recovery concern within the Personal Knowledge subsystem, including contracts, invariants, runtime behavior, persistence, failure handling, and verification is:
...
A device can replay events from a saved cursor after interruption or reinstall.
