...
Motor de sincronización existe para calcula manifests, diferencias, planes, transferencias, checkpoints y commit local. Esta especificación gobierna sus documentos subordinados y la implementación ubicada en `packages/synchronization-engine`.
