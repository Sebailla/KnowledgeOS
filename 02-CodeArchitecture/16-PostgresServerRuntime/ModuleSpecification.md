...
Runtime postgresql del servidor existe para compone el driver, migraciones, transacciones, readiness y ciclo de vida de la conexión. Esta especificación gobierna sus documentos subordinados y la implementación ubicada en `packages/postgres-server-runtime, packages/postgres-driver y adaptadores de infraestructura`.
