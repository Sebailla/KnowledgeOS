...
- defining a typed and owner-scoped representation of vector normalization, cosine similarity, invalid vectors, thresholds, and deterministic ties;
...
The normative flow for vector normalization, cosine similarity, invalid vectors, thresholds, and deterministic ties is:
...
Semantic retrieval uses cosine similarity over equal-dimension vectors.

Zero vectors return similarity zero.
