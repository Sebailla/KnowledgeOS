...
- defining a typed and owner-scoped representation of model identity, dimension compatibility, migration, stale detection, and rollback;
...
The normative flow for model identity, dimension compatibility, migration, stale detection, and rollback is:
...
Embeddings are keyed by Search Document and model ID.

Multiple model generations can coexist during migration or reindexing.
