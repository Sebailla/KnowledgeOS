...
- defining a typed and owner-scoped representation of vector storage schema, serialization, dimensions, lookup, filtering, and migration;
...
The normative flow for vector storage schema, serialization, dimensions, lookup, filtering, and migration is:
...
SQLite stores normalized vectors as JSON arrays behind a repository.

This preserves portability until a native vector extension is selected.
