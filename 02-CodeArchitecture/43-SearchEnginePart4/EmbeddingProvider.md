...
- defining a typed and owner-scoped representation of embedding contracts, dimensions, normalization, model identity, batching, caching, and failures;
...
The normative flow for embedding contracts, dimensions, normalization, model identity, batching, caching, and failures is:
...
Providers expose batch embedding through one stable contract.

Local, remote and plugin-provided models can implement the same interface.
