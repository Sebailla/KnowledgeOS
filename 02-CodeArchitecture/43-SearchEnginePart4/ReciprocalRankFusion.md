...
- defining a typed and owner-scoped representation of RRF constants, rank handling, duplicate identities, and explainability;
...
The normative flow for RRF constants, rank handling, duplicate identities, and explainability is:
...
RRF combines rankings rather than raw score scales.

Documents appearing in both lexical and semantic lists receive a stable advantage.
