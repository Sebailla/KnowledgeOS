...
Worker de sincronización existe para ejecuta planes con leases, cancelación, progreso, reanudación y aislamiento de fallos. Esta especificación gobierna sus documentos subordinados y la implementación ubicada en `packages/synchronization-worker`.
