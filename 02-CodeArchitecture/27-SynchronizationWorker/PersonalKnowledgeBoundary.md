...
**Project:** KnowledgeOS  
**Section:** Code Architecture / 27-SynchronizationWorker  
**Document:** PersonalKnowledgeBoundary  
**Version:** 5.6.2  
**Status:** Consolidated  
**Implemented by:** `packages/synchronization-worker`  
**Last updated:** 2026-08-02

---
## 1. Propósito

Este documento desarrolla **contratos, invariantes, flujo operacional y relación con el resto del subsistema** dentro de worker de sincronización. No redefine la visión del producto ni sustituye los ADR; traduce esas decisiones a reglas implementables y verificables para ejecuta planes con leases, cancelación, progreso, reanudación y aislamiento de fallos.
...
Worker de sincronización se ubica entre los contratos de dominio y los adaptadores operativos. Sus consumidores no deben depender de tablas, rutas físicas ni implementaciones concretas. La dirección de dependencia es desde adaptadores hacia contratos estables.
...
La implementación reside principalmente en `packages/synchronization-worker`. La separación recomendada distingue: contratos y modelos; servicio de aplicación; puertos de repositorio o transporte; adaptadores de infraestructura; composición productiva; y pruebas de integración.
...
**Implementación principal:** `packages/synchronization-worker`.

**Documentación rectora:** `02-CodeArchitecture/27-SynchronizationWorker/ModuleSpecification.md`.
...
This worker transfers canonical publication bytes and publication manifests only.

Annotations, highlights, notes and other Personal Knowledge never enter this execution path.
