...
- defining a typed and owner-scoped representation of tombstone creation, propagation, retention, restoration, and compaction;
...
The normative flow for tombstone creation, propagation, retention, restoration, and compaction is:
...
Deletion creates a new revision with `deleted = true`.

History remains available for synchronization and recovery.
