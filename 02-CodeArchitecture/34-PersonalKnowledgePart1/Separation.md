...
- defining a typed and owner-scoped representation of the separation concern within the Personal Knowledge subsystem, including contracts, invariants, runtime behavior, persistence, failure handling, and verification;
...
The normative flow for the separation concern within the Personal Knowledge subsystem, including contracts, invariants, runtime behavior, persistence, failure handling, and verification is:
...
# Separation from Canonical Content

Personal Knowledge is stored independently from Master and Local Publication bytes.

A user action never rewrites canonical content.
