...
- defining a typed and owner-scoped representation of revision vectors, version comparison, causality, and merge preconditions;
...
The normative flow for revision vectors, version comparison, causality, and merge preconditions is:
...
Every mutation increments the revision number and stores an immutable snapshot in revision history.

Stale updates fail through optimistic revision checks.
