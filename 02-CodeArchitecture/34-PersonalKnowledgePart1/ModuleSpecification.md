# Module Specification — 34-PersonalKnowledgePart1
...
- `Anchors.md` — stable references to source content, resolution quality, drift, and orphan handling.
- `ItemModel.md` — canonical personal knowledge item identity, kind, provenance, confidence, and lifecycle.
- `NextStep.md` — implemented boundary, intentionally deferred capabilities, prerequisites, and compatibility constraints.
- `Ownership.md` — owner isolation in domain contracts, persistence keys, queries, and authorization.
...
- `Revisioning.md` — revision vectors, version comparison, causality, and merge preconditions.
...
- `Separation.md` — the separation concern within the Personal Knowledge subsystem, including contracts, invariants, runtime behavior, persistence, failure handling, and verification.
- `SoftDeletion.md` — tombstone creation, propagation, retention, restoration, and compaction.
- `SyncPreparation.md` — incremental exchange, envelopes, cursors, acknowledgements, conflicts, and replay safety.
