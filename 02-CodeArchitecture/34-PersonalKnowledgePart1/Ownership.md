...
- defining a typed and owner-scoped representation of owner isolation in domain contracts, persistence keys, queries, and authorization;
...
The normative flow for owner isolation in domain contracts, persistence keys, queries, and authorization is:
...
Every item belongs to one owner.

Mutation requires owner identity to match the stored item.
