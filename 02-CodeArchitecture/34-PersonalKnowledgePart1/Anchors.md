...
- defining a typed and owner-scoped representation of stable references to source content, resolution quality, drift, and orphan handling;
...
The normative flow for stable references to source content, resolution quality, drift, and orphan handling is:
...
- text ranges tied to Publication ID and Version ID;
- page coordinates tied to Publication ID and Version ID.

Anchors are explicit about canonical version identity.
