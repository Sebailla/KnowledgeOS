...
Runtime postgresql de sincronización existe para persiste manifests, planes, checkpoints y leases para ejecución distribuida. Esta especificación gobierna sus documentos subordinados y la implementación ubicada en `packages/synchronization-postgres-runtime`.
