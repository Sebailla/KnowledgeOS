...
Composición productiva de cargas reanudables existe para integra API, persistencia, almacenamiento, limpieza, observabilidad y políticas operativas. Esta especificación gobierna sus documentos subordinados y la implementación ubicada en `packages/resumable-uploads-production-runtime`.
