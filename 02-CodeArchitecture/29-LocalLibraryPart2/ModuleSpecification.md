...
Persistencia y recuperación de biblioteca local existe para integra SQLite, filesystem, scanner, reparación, estadísticas y transacciones. Esta especificación gobierna sus documentos subordinados y la implementación ubicada en `packages/local-library-sqlite y packages/local-library-filesystem`.
