...
Este documento desarrolla **estrategia de pruebas, fixtures, propiedades, fallos y criterios de aceptación** dentro de persistencia PostgreSQL de cargas reanudables. No redefine la visión del producto ni sustituye los ADR; traduce esas decisiones a reglas implementables y verificables para mantiene sesiones, chunks, leases, locks y finalización idempotente.
...
- rejection of concurrent ownership;
- owner release;
- takeover;
