...
Persistencia postgresql de cargas reanudables existe para mantiene sesiones, chunks, leases, locks y finalización idempotente. Esta especificación gobierna sus documentos subordinados y la implementación ubicada en `packages/resumable-uploads-postgres`.
