...
Este documento desarrolla **visión rectora, límites, dependencias y mapa de lectura del módulo** dentro de persistencia PostgreSQL de cargas reanudables. No redefine la visión del producto ni sustituye los ADR; traduce esas decisiones a reglas implementables y verificables para mantiene sesiones, chunks, leases, locks y finalización idempotente.
...
# Resumable Uploads PostgreSQL

**Project:** KnowledgeOS  
**Section:** Code Architecture / Resumable Uploads PostgreSQL  
**Version:** 5.0  
**Status:** Release Candidate  

This block adds durable multi-instance coordination to resumable uploads.
