...
The Library is a logical model independent from SQLite, NAS or cloud providers. All consumers use Library contracts rather than direct storage access.
