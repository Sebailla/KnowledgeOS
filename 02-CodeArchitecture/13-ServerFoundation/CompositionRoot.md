...
> # Composition Root
> The server composition root creates and connects:
> - Kernel buses;
> - Domain factories;
> - Library handlers;
> - repositories;
...
> - HTTP routes;
> - health checks.
> Dependency construction occurs only in the application layer.
