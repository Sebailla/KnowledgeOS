...
- El mapeo hacia HTTP u otros protocolos ocurre únicamente en el adaptador de transporte.
...
> # Error Mapping
> Stable KnowledgeOS error categories map to HTTP status codes.
> Unexpected errors return a safe generic response. Internal causes remain protected diagnostics.
