...
- Los secretos se transportan por referencias seguras y nunca se registran en logs.
...
> Configuration is loaded explicitly and validated before startup.
> Required:
> - `DATABASE_URL`
> Optional:
> - `SERVER_HOST`
...
> - `NODE_ENV`
> Secrets are referenced through environment or an approved secret provider and never logged.
