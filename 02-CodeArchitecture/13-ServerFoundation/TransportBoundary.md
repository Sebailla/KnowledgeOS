...
- Timeouts, límites de cuerpo, autenticación y serialización se aplican antes de invocar el caso de uso.
...
> # Transport Boundary
> The server application does not expose Domain aggregates directly.
> Transport DTOs remain defined in `@knowledgeos/contracts`. HTTP is an adapter over those contracts.
