...
> # Next Step
> The next implementation step is a concrete Node.js runtime adapter:
> - native HTTP or approved framework adapter;
> - PostgreSQL driver implementing `SqlDatabase`;
> - transaction-aware Library repositories;
> - migrations at startup or deployment;
