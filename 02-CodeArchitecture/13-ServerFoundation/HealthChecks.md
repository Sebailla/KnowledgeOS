...
- Los checks deben ser acotados y no amplificar fallos de infraestructura.
...
> - `/health/ready` evaluates application and dependency readiness.
> Production composition will add PostgreSQL, storage and workflow checks.
