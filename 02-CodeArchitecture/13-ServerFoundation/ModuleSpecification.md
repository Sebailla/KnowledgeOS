        # Fundación del servidor — Module Specification
        ...
        **Last updated:** 2026-08-02
        ...
        Define composition root, configuración, transporte, health checks, API inicial y mapeo de errores.
        ...
        | Package | Role |
        |---|---|
        | `packages/client-sdk` | Implementación o contratos asociados a Fundación del servidor. |
| `packages/observability` | Implementación o contratos asociados a Fundación del servidor. |
