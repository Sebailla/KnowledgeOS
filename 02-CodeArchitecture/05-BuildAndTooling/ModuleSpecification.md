# Build y herramientas — Module Specification
...
Define compilación TypeScript y Swift, generación de código, análisis estático y reproducibilidad del toolchain.
...
| Package | Role |
|---|---|
| `packages/tooling` | Implementación o contratos asociados a Build y herramientas. |
