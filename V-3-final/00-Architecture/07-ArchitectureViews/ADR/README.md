...
* `ADR-013-Master-Library-Local-Libraries-and-Personal-Sync.md` — separates NAS Master Library authority, selective local Libraries and iCloud/CloudKit personal synchronization.
