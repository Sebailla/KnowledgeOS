...
const password = process.env.LOCAL_BROWSER_PASSWORD || `local-${crypto.randomUUID()}`;
...
const passwordPath = secret('local_browser_password.txt', password);
...
if (existsSync(passwordPath)) rmSync(passwordPath, { force: true });
