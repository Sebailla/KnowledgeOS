...
* complete consistency with `EngineResponsibilities.md`;
...
* references to future ADR README files that do not exist;
...
The known historical ADR set includes decisions related to:
...
These ADRs shall be reviewed one by one against V3.
...
No accepted ADR shall be silently rewritten to hide its historical decision.
...
* accepted ADRs have explicit V3 status;
...
* ADR consolidation remains incomplete;
...
ADRs require classification and consolidation.
