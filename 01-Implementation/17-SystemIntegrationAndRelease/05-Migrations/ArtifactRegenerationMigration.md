# Artifact Regeneration Migration

**Project:** KnowledgeOS  
**Section:** Implementation / System Integration and Release / 05-Migrations  
**Document:** ArtifactRegenerationMigration  
**Version:** 4.0  
...
Define the artifact regeneration migration for System Integration and Release, covering database, local store, CloudKit, contracts, plugins and derived-state migrations.
