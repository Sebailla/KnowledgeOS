...
**Document:** DatabaseMigrationPlan  
**Version:** 4.0  
...
Define the database migration plan for System Integration and Release, covering database, local store, CloudKit, contracts, plugins and derived-state migrations.
