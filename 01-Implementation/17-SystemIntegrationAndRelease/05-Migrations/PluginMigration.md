...
**Project:** KnowledgeOS  
**Section:** Implementation / System Integration and Release / 05-Migrations  
**Document:** PluginMigration  
**Version:** 4.0  
...
Define the plugin migration for System Integration and Release, covering database, local store, CloudKit, contracts, plugins and derived-state migrations.
