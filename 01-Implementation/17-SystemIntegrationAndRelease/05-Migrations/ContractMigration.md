...
Define the contract migration for System Integration and Release, covering database, local store, CloudKit, contracts, plugins and derived-state migrations.
