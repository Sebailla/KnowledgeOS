...
Define the local store migration plan for System Integration and Release, covering database, local store, CloudKit, contracts, plugins and derived-state migrations.
