...
**Document:** IndexRebuildMigration  
**Version:** 4.0  
...
Define the index rebuild migration for System Integration and Release, covering database, local store, CloudKit, contracts, plugins and derived-state migrations.
