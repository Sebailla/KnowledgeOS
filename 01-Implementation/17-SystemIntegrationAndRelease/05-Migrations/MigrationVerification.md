...
**Document:** MigrationVerification  
**Version:** 4.0  
...
Define the migration verification for System Integration and Release, covering database, local store, CloudKit, contracts, plugins and derived-state migrations.
