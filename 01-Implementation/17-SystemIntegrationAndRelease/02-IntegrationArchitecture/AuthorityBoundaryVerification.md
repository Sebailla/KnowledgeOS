...
**Project:** KnowledgeOS  
**Section:** Implementation / System Integration and Release / 02-IntegrationArchitecture  
**Document:** AuthorityBoundaryVerification  
**Version:** 4.0  
...
Define the authority boundary verification for System Integration and Release, covering cross-module dependencies, contracts, authority, identity and failure propagation.
...
- Cross-module calls SHALL use public contracts.
- No module SHALL access another module's private repository.
- Failure propagation SHALL preserve stable error categories and correlation.
- Identity mapping SHALL remain explicit across APIs, stores and providers.
- Compatibility checks SHALL occur before incompatible work is admitted.
