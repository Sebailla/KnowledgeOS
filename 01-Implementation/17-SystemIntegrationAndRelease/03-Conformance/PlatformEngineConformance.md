...
Define the platform engine conformance for System Integration and Release, covering architecture, ADR, invariant, contract, security and documentation conformance.
