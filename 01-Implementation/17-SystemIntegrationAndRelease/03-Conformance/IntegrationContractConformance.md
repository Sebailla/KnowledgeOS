...
**Document:** IntegrationContractConformance  
**Version:** 4.0  
...
Define the integration contract conformance for System Integration and Release, covering architecture, ADR, invariant, contract, security and documentation conformance.
