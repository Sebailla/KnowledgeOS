...
**Project:** KnowledgeOS  
**Section:** Implementation / System Integration and Release / 09-BetaAndRollout  
**Document:** TelemetryReview  
**Version:** 4.0  
...
Define the telemetry review for System Integration and Release, covering alpha, beta, feature flags, cohorts, telemetry and rollout exit criteria.
...
- Feature flags SHALL not bypass security or data-integrity controls.
- Rollout cohorts SHALL be identifiable without exposing unnecessary Personal Knowledge.
- Exit criteria SHALL be measurable.
- Telemetry SHALL be privacy-controlled and non-authoritative.
