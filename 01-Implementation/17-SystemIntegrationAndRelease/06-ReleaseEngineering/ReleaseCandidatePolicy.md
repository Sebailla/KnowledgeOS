...
**Document:** ReleaseCandidatePolicy  
**Version:** 4.0  
...
Define the release candidate policy for System Integration and Release, covering versioning, reproducible builds, signing, SBOM and release manifests.
