...
**Document:** LongRunningStabilityTests  
**Version:** 4.0  
...
Define the long running stability tests for System Integration and Release, covering system, cross-platform, upgrade, migration, recovery, load and release-candidate verification.
