...
Define the migration tests for System Integration and Release, covering system, cross-platform, upgrade, migration, recovery, load and release-candidate verification.
