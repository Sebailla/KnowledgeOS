...
**Document:** CompatibilityMatrixTests  
**Version:** 4.0  
...
Define the compatibility matrix tests for System Integration and Release, covering system, cross-platform, upgrade, migration, recovery, load and release-candidate verification.
