...
**Project:** KnowledgeOS  
**Section:** Implementation / System Integration and Release / 12-Testing  
**Document:** RollbackTests  
**Version:** 4.0  
...
Define the rollback tests for System Integration and Release, covering system, cross-platform, upgrade, migration, recovery, load and release-candidate verification.
...
- Tests SHALL run against immutable release-candidate artifacts.
- Upgrade and rollback tests SHALL use supported prior versions.
- Long-running tests SHALL include resource-leak detection.
- Accessibility verification SHALL cover released client platforms.
