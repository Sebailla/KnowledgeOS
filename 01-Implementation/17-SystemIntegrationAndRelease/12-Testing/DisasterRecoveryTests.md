...
**Document:** DisasterRecoveryTests  
**Version:** 4.0  
...
Define the disaster recovery tests for System Integration and Release, covering system, cross-platform, upgrade, migration, recovery, load and release-candidate verification.
