...
**Document:** ReleaseCandidateTests  
**Version:** 4.0  
...
Define the release candidate tests for System Integration and Release, covering system, cross-platform, upgrade, migration, recovery, load and release-candidate verification.
