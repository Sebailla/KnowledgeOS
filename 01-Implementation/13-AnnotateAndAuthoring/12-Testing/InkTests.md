...
**Project:** KnowledgeOS  
**Section:** Implementation / Annotate and Authoring / 12-Testing  
**Document:** InkTests  
**Version:** 4.0  
...
Define the ink tests for Annotate and Authoring, covering anchor, synchronization, conflict, ink, security and accessibility verification.
...
- Tests SHALL verify anchors across compatible reprocessing.
- Tests SHALL verify offline editing and later convergence.
- Tests SHALL prove Personal Knowledge never enters Master Library persistence.
- Performance tests SHALL cover large annotation and ink collections.
