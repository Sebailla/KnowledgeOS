...
Define the conflict tests for Annotate and Authoring, covering anchor, synchronization, conflict, ink, security and accessibility verification.
...
- Synchronization SHALL preserve annotation and version identities across devices.
- CloudKit record identifiers SHALL remain provider implementation details.
- Merge results SHALL identify all parent versions.
- Unknown commit state SHALL be reconciled before retry.
- Provider outage SHALL not block offline authoring.
