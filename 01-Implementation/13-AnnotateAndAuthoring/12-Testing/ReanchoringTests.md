...
Define the reanchoring tests for Annotate and Authoring, covering anchor, synchronization, conflict, ink, security and accessibility verification.
...
- Anchors SHALL distinguish semantic, presentation and hybrid selectors.
- Resolution confidence and candidate targets SHALL be explicit.
- Automatic reanchoring SHALL not silently discard the former target.
- Text anchors SHOULD include context sufficient for resilient recovery.
