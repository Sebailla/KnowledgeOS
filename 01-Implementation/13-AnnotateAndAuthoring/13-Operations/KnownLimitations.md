...
**Project:** KnowledgeOS  
**Section:** Implementation / Annotate and Authoring / 13-Operations  
...
Define the known limitations for Annotate and Authoring, covering configuration, observability, capacity and release readiness.
