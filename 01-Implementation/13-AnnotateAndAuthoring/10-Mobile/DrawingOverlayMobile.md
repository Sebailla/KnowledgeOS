# Drawing Overlay Mobile

**Project:** KnowledgeOS  
**Section:** Implementation / Annotate and Authoring / 10-Mobile  
**Document:** DrawingOverlayMobile  
**Version:** 4.0  
...
Define the drawing overlay mobile for Annotate and Authoring, covering iPhone and iPad annotation, PencilKit, touch and multitasking.
...
- Ink and attachments SHALL use Personal asset identities.
- Stroke serialization SHALL preserve coordinate space, tool, timing and pressure when available.
- Ink rendering SHALL not modify DPM.
- Binary integrity SHOULD use cryptographic checksums.
- Apple Pencil and PencilKit types SHALL remain behind implementation adapters.
- Editor state SHALL remain separate from committed annotation state.
- Accessibility SHALL cover selection, editor controls, annotation markers and errors.
- Platform UI code SHALL not own annotation business rules.
- Multiwindow and multiscene editing SHALL use explicit session scopes.
