...
**Project:** KnowledgeOS  
**Section:** Implementation / Annotate and Authoring / 08-Synchronization  
**Document:** SyncEnvelopeMapping  
**Version:** 4.0  
...
Define the sync envelope mapping for Annotate and Authoring, covering Personal Knowledge change tracking, CloudKit mapping, conflicts and convergence.
