# Get Orphaned Annotations Query

**Project:** KnowledgeOS  
**Section:** Implementation / Annotate and Authoring / 06-Contracts  
**Document:** GetOrphanedAnnotationsQuery  
**Version:** 4.0  
...
Define the get orphaned annotations query for Annotate and Authoring, covering commands, queries, events, DTOs and compatibility.
