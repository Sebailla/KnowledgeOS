# Merge Annotation Conflict Command

**Project:** KnowledgeOS  
**Section:** Implementation / Annotate and Authoring / 06-Contracts  
**Document:** MergeAnnotationConflictCommand  
**Version:** 4.0  
...
Define the merge annotation conflict command for Annotate and Authoring, covering commands, queries, events, DTOs and compatibility.
