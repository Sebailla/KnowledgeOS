...
**Document:** CreateAnnotationCommand  
**Version:** 4.0  
...
Define the create annotation command for Annotate and Authoring, covering commands, queries, events, DTOs and compatibility.
