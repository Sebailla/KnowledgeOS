...
**Document:** DeleteAnnotationCommand  
**Version:** 4.0  
...
Define the delete annotation command for Annotate and Authoring, covering commands, queries, events, DTOs and compatibility.
