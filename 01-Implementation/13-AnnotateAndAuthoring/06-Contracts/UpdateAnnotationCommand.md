...
**Document:** UpdateAnnotationCommand  
**Version:** 4.0  
...
Define the update annotation command for Annotate and Authoring, covering commands, queries, events, DTOs and compatibility.
