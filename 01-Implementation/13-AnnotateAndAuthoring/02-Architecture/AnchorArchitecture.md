...
**Project:** KnowledgeOS  
**Section:** Implementation / Annotate and Authoring / 02-Architecture  
**Document:** AnchorArchitecture  
**Version:** 4.0  
...
Define the anchor architecture for Annotate and Authoring, covering module boundaries, state, lifecycle, anchors and conflict behavior.
