...
**Document:** AuthoringArchitecture  
**Version:** 4.0  
...
Define the authoring architecture for Annotate and Authoring, covering module boundaries, state, lifecycle, anchors and conflict behavior.
