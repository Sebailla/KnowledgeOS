...
**Project:** KnowledgeOS  
**Section:** Implementation / Annotate and Authoring / 07-Persistence  
**Document:** AttachmentStore  
**Version:** 4.0  
...
Define the attachment store for Annotate and Authoring, covering local stores, versions, conflicts, tombstones, migrations and integrity.
...
- Published Personal Knowledge versions SHALL be immutable.
- Persistence SHALL remain device-local and recoverable.
- Migrations SHALL preserve identity, provenance, anchors and conflict branches.
- Corrupt derived previews SHALL be discarded before Personal Knowledge.
