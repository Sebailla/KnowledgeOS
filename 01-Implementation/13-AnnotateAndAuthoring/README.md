# Annotate And Authoring

**Project:** KnowledgeOS  
**Section:** Implementation  
**Document:** 13-AnnotateAndAuthoring/README  
**Version:** 4.0  
...
This document is the rector index for `01-Implementation/13-AnnotateAndAuthoring`.
...
- [`03-AnnotationModel`](03-AnnotationModel/README.md)
- [`04-Anchors`](04-Anchors/README.md)
- [`05-InkAndAssets`](05-InkAndAssets/README.md)
- [`06-Contracts`](06-Contracts/README.md)
- [`07-Persistence`](07-Persistence/README.md)
- [`08-Synchronization`](08-Synchronization/README.md)
