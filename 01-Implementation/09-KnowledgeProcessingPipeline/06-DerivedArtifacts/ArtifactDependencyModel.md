...
**Document:** ArtifactDependencyModel  
**Version:** 4.0  
...
Define the artifact dependency model for the Knowledge Processing Pipeline, covering thumbnails, previews, indexes, embeddings and graph projections.
