...
**Document:** KnowledgeGraphProjection  
**Version:** 4.0  
...
Define the knowledge graph projection for the Knowledge Processing Pipeline, covering thumbnails, previews, indexes, embeddings and graph projections.
