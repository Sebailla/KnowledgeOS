...
Define the dpmconformance tests for the Knowledge Processing Pipeline, covering conformance, determinism, idempotency, recovery and security verification.
...
- DPM generation SHALL preserve presentation independently of UDM semantics.
- Every spatial value SHALL reference an explicit coordinate space.
- Reading flow SHALL be explicit and independent of z-order.
- UDM-DPM mappings SHALL preserve cardinality, confidence and provenance.
