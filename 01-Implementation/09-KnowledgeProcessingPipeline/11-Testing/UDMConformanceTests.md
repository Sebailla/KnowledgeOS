...
Define the udmconformance tests for the Knowledge Processing Pipeline, covering conformance, determinism, idempotency, recovery and security verification.
...
- UDM generation SHALL preserve semantic structure independently of presentation.
- Every UDM node SHALL have exactly one primary type.
- Containment SHALL be acyclic and explicitly ordered.
- Anchors SHALL preserve source selectors and resolution history.
