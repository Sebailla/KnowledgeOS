# Get Processing Manifest Query

**Project:** KnowledgeOS  
**Section:** Implementation / Knowledge Processing Pipeline / 07-Contracts  
**Document:** GetProcessingManifestQuery  
**Version:** 4.0  
...
Define the get processing manifest query for the Knowledge Processing Pipeline, covering commands, queries, events, DTOs and compatibility.
