# Reprocess Publication Command

**Project:** KnowledgeOS  
**Section:** Implementation / Knowledge Processing Pipeline / 07-Contracts  
**Document:** ReprocessPublicationCommand  
**Version:** 4.0  
...
Define the reprocess publication command for the Knowledge Processing Pipeline, covering commands, queries, events, DTOs and compatibility.
