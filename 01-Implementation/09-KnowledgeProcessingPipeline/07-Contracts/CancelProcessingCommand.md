...
**Document:** CancelProcessingCommand  
**Version:** 4.0  
...
Define the cancel processing command for the Knowledge Processing Pipeline, covering commands, queries, events, DTOs and compatibility.
