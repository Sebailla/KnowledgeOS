...
**Document:** GetProcessingStatusQuery  
**Version:** 4.0  
...
Define the get processing status query for the Knowledge Processing Pipeline, covering commands, queries, events, DTOs and compatibility.
