...
**Document:** ProcessPublicationCommand  
**Version:** 4.0  
...
Define the process publication command for the Knowledge Processing Pipeline, covering commands, queries, events, DTOs and compatibility.
