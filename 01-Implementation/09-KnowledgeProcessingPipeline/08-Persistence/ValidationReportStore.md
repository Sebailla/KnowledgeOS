...
**Document:** ValidationReportStore  
**Version:** 4.0  
...
Define the validation report store for the Knowledge Processing Pipeline, covering manifests, checkpoints, journals, artifact registry and retention.
