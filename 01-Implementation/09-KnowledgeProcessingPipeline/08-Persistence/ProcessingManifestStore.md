...
Define the processing manifest store for the Knowledge Processing Pipeline, covering manifests, checkpoints, journals, artifact registry and retention.
