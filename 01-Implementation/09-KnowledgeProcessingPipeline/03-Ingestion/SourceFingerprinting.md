...
**Project:** KnowledgeOS  
**Section:** Implementation / Knowledge Processing Pipeline / 03-Ingestion  
**Document:** SourceFingerprinting  
**Version:** 4.0  
...
Define the source fingerprinting for the Knowledge Processing Pipeline, covering source validation, format detection, extraction and provenance.
...
- Canonical ordering SHALL be explicit.
- Randomness, locale, timezone and clock dependencies SHALL be controlled or recorded.
- Source and configuration fingerprints SHALL use stable algorithms.
