...
**Project:** KnowledgeOS  
**Section:** Implementation / Knowledge Processing Pipeline / 09-Execution  
...
Define the resource policy for the Knowledge Processing Pipeline, covering workflows, jobs, scheduling, retries, resources and resume.
...
- Jobs SHALL declare retry, timeout and resource policies.
- Parallel execution SHALL merge deterministically where output is canonical.
- Cancellation SHALL preserve completed consistent outputs and checkpoints.
