...
**Document:** NodeIdentityPreservation  
**Version:** 4.0  
...
Define the node identity preservation for the Knowledge Processing Pipeline, covering canonical semantic generation, identity, anchors and validation.
