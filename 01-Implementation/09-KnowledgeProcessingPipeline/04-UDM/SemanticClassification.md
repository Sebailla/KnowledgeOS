...
**Document:** SemanticClassification  
**Version:** 4.0  
...
Define the semantic classification for the Knowledge Processing Pipeline, covering canonical semantic generation, identity, anchors and validation.
