...
**Document:** AIProviderIntegration  
**Version:** 4.0  
...
Define the aiprovider integration for the Knowledge Processing Pipeline, covering OCR, AI, embedding and parser provider integration.
