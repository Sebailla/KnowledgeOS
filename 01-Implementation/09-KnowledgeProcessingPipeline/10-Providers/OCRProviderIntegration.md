...
**Project:** KnowledgeOS  
**Section:** Implementation / Knowledge Processing Pipeline / 10-Providers  
**Document:** OCRProviderIntegration  
**Version:** 4.0  
...
Define the ocrprovider integration for the Knowledge Processing Pipeline, covering OCR, AI, embedding and parser provider integration.
...
- Format detection SHALL use content evidence rather than filename extension alone.
- Extraction failures SHALL preserve partial evidence without publishing canonical results.
- OCR results SHALL preserve source-region mapping and confidence.
- Assets SHALL be referenced by stable identity and integrity metadata.
