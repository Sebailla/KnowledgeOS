...
**Document:** ProviderPrivacyPolicy  
**Version:** 4.0  
...
Define the provider privacy policy for the Knowledge Processing Pipeline, covering OCR, AI, embedding and parser provider integration.
