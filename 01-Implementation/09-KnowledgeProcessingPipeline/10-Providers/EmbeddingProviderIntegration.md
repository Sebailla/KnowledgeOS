...
**Document:** EmbeddingProviderIntegration  
**Version:** 4.0  
...
Define the embedding provider integration for the Knowledge Processing Pipeline, covering OCR, AI, embedding and parser provider integration.
