...
**Project:** KnowledgeOS  
**Section:** Implementation / Production / 07-Security  
**Document:** SecurityIncidentResponse  
**Version:** 4.0  
...
Define the security incident response for KnowledgeOS production, covering hardening, signing, notarization, certificates, supply chain and incidents.
...
- Critical runbooks SHALL be tested or rehearsed.
- Scheduled maintenance SHALL preserve offline client operation where applicable.
- Changes SHALL identify risk, rollback and verification.
- Operational handover SHALL include ownership, access, dashboards, alerts and known limitations.
