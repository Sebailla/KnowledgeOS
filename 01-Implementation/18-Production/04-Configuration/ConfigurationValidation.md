...
**Document:** ConfigurationValidation  
**Version:** 4.0  
...
Define the configuration validation for KnowledgeOS production, covering validated environment profiles, secrets references, feature flags and audit.
