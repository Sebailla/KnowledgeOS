...
**Document:** WebApplicationPackage  
**Version:** 4.0  
...
Define the web application package for KnowledgeOS production, covering reproducible platform packages, images, manifests and verification.
