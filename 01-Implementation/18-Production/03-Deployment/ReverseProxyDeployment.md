...
**Document:** ReverseProxyDeployment  
**Version:** 4.0  
...
Define the reverse proxy deployment for KnowledgeOS production, covering NAS, server, PostgreSQL, storage, TLS, orchestration and rollback.
