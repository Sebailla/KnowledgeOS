# Knowledge Osserver Deployment

**Project:** KnowledgeOS  
**Section:** Implementation / Production / 03-Deployment  
**Document:** KnowledgeOSServerDeployment  
**Version:** 4.0  
...
Define the knowledge osserver deployment for KnowledgeOS production, covering NAS, server, PostgreSQL, storage, TLS, orchestration and rollback.
