...
**Document:** DeploymentOrchestration  
**Version:** 4.0  
...
Define the deployment orchestration for KnowledgeOS production, covering NAS, server, PostgreSQL, storage, TLS, orchestration and rollback.
