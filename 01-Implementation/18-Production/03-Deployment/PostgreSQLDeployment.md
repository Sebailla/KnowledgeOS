# Postgre Sqldeployment

**Project:** KnowledgeOS  
**Section:** Implementation / Production / 03-Deployment  
**Document:** PostgreSQLDeployment  
**Version:** 4.0  
...
Define the postgre sqldeployment for KnowledgeOS production, covering NAS, server, PostgreSQL, storage, TLS, orchestration and rollback.
