...
**Project:** KnowledgeOS  
**Section:** Implementation / Production / 03-Deployment  
**Document:** StorageVolumeLayout  
**Version:** 4.0  
...
Define the storage volume layout for KnowledgeOS production, covering NAS, server, PostgreSQL, storage, TLS, orchestration and rollback.
