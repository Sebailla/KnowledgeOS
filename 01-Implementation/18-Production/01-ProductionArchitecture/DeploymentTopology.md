...
**Project:** KnowledgeOS  
**Section:** Implementation / Production / 01-ProductionArchitecture  
**Document:** DeploymentTopology  
**Version:** 4.0  
...
Define the deployment topology for KnowledgeOS production, covering production topology, runtime profiles, failure domains, scaling and capacity.
...
- Deployment SHALL stop before readiness when required dependencies are invalid.
- Database and application upgrades SHALL honor declared compatibility windows.
- Authoritative file volumes SHALL never be recreated implicitly during application deployment.
- TLS termination and internal trust SHALL be explicit.
- Rollback SHALL preserve schema and data compatibility.
