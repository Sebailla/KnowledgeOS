...
**Document:** DisasterRecoveryArchitecture  
**Version:** 4.0  
...
Define the disaster recovery architecture for KnowledgeOS production, covering production topology, runtime profiles, failure domains, scaling and capacity.
