...
**Document:** ProductionArchitecture  
**Version:** 4.0  
...
Define the production architecture for KnowledgeOS production, covering production topology, runtime profiles, failure domains, scaling and capacity.
