...
**Document:** ApplicationMonitoring  
**Version:** 4.0  
...
Define the application monitoring for KnowledgeOS production, covering alerts, ownership, escalation, capacity and service-specific monitoring.
