...
**Project:** KnowledgeOS  
**Section:** Implementation / Production / 06-Monitoring  
**Document:** AlertingArchitecture  
**Version:** 4.0  
...
Define the alerting architecture for KnowledgeOS production, covering alerts, ownership, escalation, capacity and service-specific monitoring.
...
- Every production alert SHALL have an owner and actionable response.
- Alert thresholds SHALL avoid both silent failure and uncontrolled noise.
- Monitoring SHALL cover database, storage, backups, workflows, sync and providers.
- Escalation paths SHALL be documented and rehearsed.
