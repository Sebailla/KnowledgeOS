...
**Project:** KnowledgeOS  
**Section:** Implementation / Production / 05-Observability  
**Document:** ObservabilityArchitecture  
**Version:** 4.0  
...
Define the observability architecture for KnowledgeOS production, covering logging, metrics, tracing, health, privacy, dashboards and SLOs.
...
- Metrics SHALL define units and bounded labels.
- Correlation SHALL propagate across commands, events, jobs and workflows.
- Publication text, Personal Knowledge and credentials SHALL be redacted before telemetry export.
- Dashboards SHALL distinguish infrastructure success from business-operation success.
- SLOs SHALL use measurable indicators and explicit evaluation windows.
