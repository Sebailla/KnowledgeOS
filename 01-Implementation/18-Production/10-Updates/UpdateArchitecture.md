...
**Project:** KnowledgeOS  
**Section:** Implementation / Production / 10-Updates  
**Document:** UpdateArchitecture  
**Version:** 4.0  
...
Define the update architecture for KnowledgeOS production, covering platform updates, schema changes, compatibility windows and rollback.
