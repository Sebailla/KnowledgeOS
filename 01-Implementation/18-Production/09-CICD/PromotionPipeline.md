...
Define the promotion pipeline for KnowledgeOS production, covering build, test, security, signing, release, promotion, deployment and hotfix pipelines.
