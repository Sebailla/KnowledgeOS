# Publication Files Backup

**Project:** KnowledgeOS  
**Section:** Implementation / Production / 08-BackupAndRecovery  
**Document:** PublicationFilesBackup  
**Version:** 4.0  
...
Define the publication files backup for KnowledgeOS production, covering consistent backups, restore, PITR, disaster recovery and objectives.
