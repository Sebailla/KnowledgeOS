...
**Document:** RecoveryTimeObjectives  
**Version:** 4.0  
...
Define the recovery time objectives for KnowledgeOS production, covering consistent backups, restore, PITR, disaster recovery and objectives.
