...
**Project:** KnowledgeOS  
**Section:** Implementation / Export and Publishing / 08-Persistence  
**Document:** ExportManifestStore  
**Version:** 4.0  
...
Define the export manifest store for Export and Publishing, covering profiles, registries, artifacts, reports, checkpoints and retention.
...
- Canonical ordering SHALL be used where hashing or signing applies.
- Randomness, clock, locale and timezone dependencies SHALL be explicit.
- Output manifests SHALL record processor, profile and dependency versions.
- Output identity SHALL remain distinct from source Knowledge Object identity.
