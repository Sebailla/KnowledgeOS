...
**Project:** KnowledgeOS  
**Section:** Implementation / Export and Publishing / 06-Publishing  
**Document:** PublicationManifest  
**Version:** 4.0  
...
Define the publication manifest for Export and Publishing, covering local and remote publishing, manifests, identity, signing and delivery.
