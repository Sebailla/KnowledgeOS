...
**Document:** RenderingArchitecture  
**Version:** 4.0  
...
Define the rendering architecture for Export and Publishing, covering pipeline, profiles, transformation, rendering, packaging and publishing.
