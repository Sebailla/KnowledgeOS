...
**Document:** PublishingArchitecture  
**Version:** 4.0  
...
Define the publishing architecture for Export and Publishing, covering pipeline, profiles, transformation, rendering, packaging and publishing.
