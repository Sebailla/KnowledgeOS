...
**Document:** PackagingArchitecture  
**Version:** 4.0  
...
Define the packaging architecture for Export and Publishing, covering pipeline, profiles, transformation, rendering, packaging and publishing.
