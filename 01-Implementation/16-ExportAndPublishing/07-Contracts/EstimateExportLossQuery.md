# Estimate Export Loss Query

**Project:** KnowledgeOS  
**Section:** Implementation / Export and Publishing / 07-Contracts  
**Document:** EstimateExportLossQuery  
**Version:** 4.0  
...
Define the estimate export loss query for Export and Publishing, covering commands, queries, events, DTOs and compatibility.
...
- Events SHALL follow committed export-registry state.
- DTOs SHALL not expose filesystem paths or provider internals.
