# List Export Profiles Query

**Project:** KnowledgeOS  
**Section:** Implementation / Export and Publishing / 07-Contracts  
**Document:** ListExportProfilesQuery  
**Version:** 4.0  
...
Define the list export profiles query for Export and Publishing, covering commands, queries, events, DTOs and compatibility.
