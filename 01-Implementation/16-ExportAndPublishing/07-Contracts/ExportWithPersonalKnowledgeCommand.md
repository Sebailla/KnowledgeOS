# Export With Personal Knowledge Command

**Project:** KnowledgeOS  
**Section:** Implementation / Export and Publishing / 07-Contracts  
**Document:** ExportWithPersonalKnowledgeCommand  
**Version:** 4.0  
...
Define the export with personal knowledge command for Export and Publishing, covering commands, queries, events, DTOs and compatibility.
