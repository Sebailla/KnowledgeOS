...
**Document:** ExportCollectionCommand  
**Version:** 4.0  
...
Define the export collection command for Export and Publishing, covering commands, queries, events, DTOs and compatibility.
