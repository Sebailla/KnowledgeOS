# Get Export Capabilities Query

**Project:** KnowledgeOS  
**Section:** Implementation / Export and Publishing / 07-Contracts  
**Document:** GetExportCapabilitiesQuery  
**Version:** 4.0  
...
Define the get export capabilities query for Export and Publishing, covering commands, queries, events, DTOs and compatibility.
