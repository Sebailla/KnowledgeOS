...
**Project:** KnowledgeOS  
**Section:** Implementation / Export and Publishing / 09-Execution  
**Document:** TransformationJobs  
**Version:** 4.0  
...
Define the transformation jobs for Export and Publishing, covering workflows, jobs, retries, cancellation, resources and resume.
...
- Parallel transformation SHALL merge deterministically.
- Unknown delivery state SHALL be reconciled before retry.
- Cancellation SHALL preserve completed valid artifacts and checkpoints.
- Resource policy SHALL protect interactive reading and annotation.
