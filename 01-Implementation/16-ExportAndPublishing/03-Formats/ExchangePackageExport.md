...
**Document:** ExchangePackageExport  
**Version:** 4.0  
...
Define the exchange package export for Export and Publishing, covering supported formats, capabilities and explicit loss behavior.
