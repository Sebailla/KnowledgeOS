...
**Document:** FormatCapabilityMatrix  
**Version:** 4.0  
...
Define the format capability matrix for Export and Publishing, covering supported formats, capabilities and explicit loss behavior.
