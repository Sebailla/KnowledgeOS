...
**Project:** KnowledgeOS  
**Section:** Implementation / Export and Publishing / 03-Formats  
**Document:** FormatLossModel  
**Version:** 4.0  
...
Define the format loss model for Export and Publishing, covering supported formats, capabilities and explicit loss behavior.
