...
**Project:** KnowledgeOS  
**Section:** Implementation / Export and Publishing / 13-Plugins  
**Document:** PluginCapabilityRequirements  
**Version:** 4.0  
...
Define the plugin capability requirements for Export and Publishing, covering exporter extension points, capabilities and isolation.
...
- Plugin exporters SHALL declare format, profile and capability support.
- Plugin execution SHALL remain isolated according to Plugin Runtime policy.
- Plugin exporters SHALL not mutate source repositories.
- Compatibility SHALL be checked before extension activation.
