...
**Document:** VisualRegressionTests  
**Version:** 4.0  
...
Define the visual regression tests for Export and Publishing, covering determinism, fidelity, loss, conformance, security and recovery verification.
