...
Define the asset packaging tests for Export and Publishing, covering determinism, fidelity, loss, conformance, security and recovery verification.
...
- Converted assets SHALL have distinct derived identities.
- Asset integrity SHALL be validated before packaging.
- External resources SHALL follow explicit download and privacy policy.
- Missing assets SHALL produce explicit failure or placeholders according to profile.
