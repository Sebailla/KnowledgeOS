...
**Project:** KnowledgeOS  
**Section:** Implementation / Export and Publishing / 04-Composition  
**Document:** CitationsAndBibliography  
**Version:** 4.0  
...
Define the citations and bibliography for Export and Publishing, covering document structure, typography, references, tables, figures and localization.
...
- Composition SHALL preserve semantic reading order.
- Cross-references SHALL resolve or appear in the loss report.
- Generated numbering SHALL be deterministic.
- Accessibility semantics SHOULD be preserved when the target supports them.
- Theme and typography choices SHALL not change source semantics.
