...
**Project:** KnowledgeOS  
**Section:** Implementation / Shared / 01-Contracts  
...
Define the contract versioning for KnowledgeOS shared implementation, covering versioned cross-process and cross-platform contracts.
