...
**Document:** SharedContractArchitecture  
**Version:** 4.0  
...
Define the shared contract architecture for KnowledgeOS shared implementation, covering versioned cross-process and cross-platform contracts.
