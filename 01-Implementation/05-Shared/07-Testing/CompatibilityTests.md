...
Define the compatibility tests for KnowledgeOS shared implementation, covering cross-platform contract, compatibility and round-trip testing.
...
- Compatibility claims SHALL be mechanically testable.
- Migrations SHALL preserve identity, authority and provenance.
