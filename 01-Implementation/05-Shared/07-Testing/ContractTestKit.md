...
Define the contract test kit for KnowledgeOS shared implementation, covering cross-platform contract, compatibility and round-trip testing.
...
- Transport contracts SHALL use explicit immutable DTOs.
- Private repository and framework types SHALL NOT appear in public contracts.
- Commands, queries and events SHALL preserve correlation and version metadata.
