...
**Document:** CrossPlatformConformance  
**Version:** 4.0  
...
Define the cross platform conformance for KnowledgeOS shared implementation, covering cross-platform contract, compatibility and round-trip testing.
