...
**Project:** KnowledgeOS  
**Section:** Implementation / Shared / 07-Testing  
**Document:** SerializationRoundTripTests  
**Version:** 4.0  
...
Define the serialization round trip tests for KnowledgeOS shared implementation, covering cross-platform contract, compatibility and round-trip testing.
...
- Serialization round trips SHALL preserve logical meaning.
- Canonical encodings SHALL use deterministic ordering where hashing or signing applies.
- Date, time, timezone and precision SHALL remain explicit.
- Parsers SHALL treat input as untrusted and enforce size and nesting limits.
- Test fixtures SHALL be versioned and contain no production secrets.
- Cross-platform conformance SHALL verify equivalent logical results.
- Round-trip tests SHALL preserve identity, authority, provenance and extension data.
