...
**Project:** KnowledgeOS  
**Section:** Implementation / Shared / 03-Serialization  
**Document:** IdentifierEncoding  
**Version:** 4.0  
...
Define the identifier encoding for KnowledgeOS shared implementation, covering portable deterministic serialization and migration support.
