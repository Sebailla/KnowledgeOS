...
**Project:** KnowledgeOS  
**Section:** Implementation / Shared / 05-ClientSDK  
**Document:** APIClientArchitecture  
**Version:** 4.0  
...
Define the apiclient architecture for KnowledgeOS shared implementation, covering typed client SDK infrastructure used by desktop, mobile and web.
...
- Client SDK behavior SHALL remain transport-neutral at its public boundary.
- Retryable mutations SHALL support idempotency.
- Pagination SHALL preserve stable ordering.
- Authentication tokens SHALL remain outside serialized business contracts.
- Offline queues SHALL preserve operation identity and compatibility version.
