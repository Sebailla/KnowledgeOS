...
**Document:** AuthenticationSupport  
**Version:** 4.0  
...
Define the authentication support for KnowledgeOS shared implementation, covering typed client SDK infrastructure used by desktop, mobile and web.
