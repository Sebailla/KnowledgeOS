...
Define the identity validation for KnowledgeOS shared implementation, covering shared schema, identity and compatibility validation.
...
- Identity kinds SHALL remain distinct and opaque.
- Aliases and external identifiers SHALL NOT replace KnowledgeOS identity.
