...
**Document:** CompatibilityValidation  
**Version:** 4.0  
...
Define the compatibility validation for KnowledgeOS shared implementation, covering shared schema, identity and compatibility validation.
