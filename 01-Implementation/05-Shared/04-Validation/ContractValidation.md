...
**Project:** KnowledgeOS  
**Section:** Implementation / Shared / 04-Validation  
**Document:** ContractValidation  
**Version:** 4.0  
...
Define the contract validation for KnowledgeOS shared implementation, covering shared schema, identity and compatibility validation.
...
- Findings SHALL use stable codes and severities.
- Validation SHALL distinguish malformed, incompatible, invalid and incomplete inputs.
