...
**Project:** KnowledgeOS  
**Section:** Implementation / Shared / 02-DomainTypes  
**Document:** IdentityTypes  
**Version:** 4.0  
...
Define the identity types for KnowledgeOS shared implementation, covering shared immutable value types that mirror approved Domain concepts.
