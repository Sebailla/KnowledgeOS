...
**Document:** DesktopIntegrationTests  
**Version:** 4.0  
...
Define the desktop integration tests for the Plugin Runtime, covering validation, compatibility, enforcement, isolation, recovery and integration.
