...
**Document:** ManifestValidationTests  
**Version:** 4.0  
...
Define the manifest validation tests for the Plugin Runtime, covering validation, compatibility, enforcement, isolation, recovery and integration.
