...
**Document:** CapabilityEnforcementTests  
**Version:** 4.0  
...
Define the capability enforcement tests for the Plugin Runtime, covering validation, compatibility, enforcement, isolation, recovery and integration.
