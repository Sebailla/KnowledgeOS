...
**Document:** MobileIntegrationTests  
**Version:** 4.0  
...
Define the mobile integration tests for the Plugin Runtime, covering validation, compatibility, enforcement, isolation, recovery and integration.
