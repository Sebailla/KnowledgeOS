...
**Document:** ProcessIsolationSecurity  
**Version:** 4.0  
...
Define the process isolation security for the Plugin Runtime, covering threat model, sandbox, signatures, integrity, isolation and supply chain.
