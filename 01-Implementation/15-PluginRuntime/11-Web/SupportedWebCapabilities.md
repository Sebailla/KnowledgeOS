...
**Document:** SupportedWebCapabilities  
**Version:** 4.0  
...
Define the supported web capabilities for the Plugin Runtime, covering optional web plugin sandbox and supported capabilities.
