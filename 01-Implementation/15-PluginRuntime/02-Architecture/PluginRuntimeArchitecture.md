...
**Document:** PluginRuntimeArchitecture  
**Version:** 4.0  
...
Define the plugin runtime architecture for the Plugin Runtime, covering host, lifecycle, capabilities, isolation, dependencies and policy.
