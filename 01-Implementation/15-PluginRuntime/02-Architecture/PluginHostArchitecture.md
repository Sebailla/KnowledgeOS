...
**Document:** PluginHostArchitecture  
**Version:** 4.0  
...
Define the plugin host architecture for the Plugin Runtime, covering host, lifecycle, capabilities, isolation, dependencies and policy.
