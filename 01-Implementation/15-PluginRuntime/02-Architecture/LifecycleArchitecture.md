...
**Document:** LifecycleArchitecture  
**Version:** 4.0  
...
Define the lifecycle architecture for the Plugin Runtime, covering host, lifecycle, capabilities, isolation, dependencies and policy.
