...
**Document:** IsolationArchitecture  
**Version:** 4.0  
...
Define the isolation architecture for the Plugin Runtime, covering host, lifecycle, capabilities, isolation, dependencies and policy.
