...
**Document:** ExtensionRegistration  
**Version:** 4.0  
...
Define the extension registration for the Plugin Runtime, covering host, lifecycle, capabilities, isolation, dependencies and policy.
