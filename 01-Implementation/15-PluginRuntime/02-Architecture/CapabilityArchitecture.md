...
**Project:** KnowledgeOS  
**Section:** Implementation / Plugin Runtime / 02-Architecture  
**Document:** CapabilityArchitecture  
**Version:** 4.0  
...
Define the capability architecture for the Plugin Runtime, covering host, lifecycle, capabilities, isolation, dependencies and policy.
