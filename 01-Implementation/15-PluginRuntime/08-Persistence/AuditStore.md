...
**Project:** KnowledgeOS  
**Section:** Implementation / Plugin Runtime / 08-Persistence  
**Document:** AuditStore  
**Version:** 4.0  
...
Define the audit store for the Plugin Runtime, covering registry, state, configuration, grants, plugin data, migrations and audit.
