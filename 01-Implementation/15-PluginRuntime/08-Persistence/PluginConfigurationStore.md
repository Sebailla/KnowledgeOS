...
**Document:** PluginConfigurationStore  
**Version:** 4.0  
...
Define the plugin configuration store for the Plugin Runtime, covering registry, state, configuration, grants, plugin data, migrations and audit.
