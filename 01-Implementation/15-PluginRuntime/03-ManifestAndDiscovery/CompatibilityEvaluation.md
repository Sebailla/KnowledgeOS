...
**Document:** CompatibilityEvaluation  
**Version:** 4.0  
...
Define the compatibility evaluation for the Plugin Runtime, covering manifest, package validation, signatures, publishers and discovery.
