...
**Project:** KnowledgeOS  
**Section:** Implementation / Plugin Runtime / 06-Execution  
**Document:** ProcessIsolation  
**Version:** 4.0  
...
Define the process isolation for the Plugin Runtime, covering isolated execution, hooks, events, commands, jobs, workflows and resource limits.
