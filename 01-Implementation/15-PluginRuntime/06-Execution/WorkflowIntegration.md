...
Define the workflow integration for the Plugin Runtime, covering isolated execution, hooks, events, commands, jobs, workflows and resource limits.
...
- UI contributions SHALL remain declarative and host-controlled.
- Plugins SHALL not obtain unrestricted view-controller or DOM access.
- Platform-specific capabilities SHALL be advertised through compatibility discovery.
- Permission UI SHALL explain requested scope and risk.
