...
**Document:** PluginExecutionContext  
**Version:** 4.0  
...
Define the plugin execution context for the Plugin Runtime, covering isolated execution, hooks, events, commands, jobs, workflows and resource limits.
