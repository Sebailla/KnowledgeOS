...
**Project:** KnowledgeOS  
**Section:** Implementation / Plugin Runtime / 05-Capabilities  
**Document:** CapabilityAudit  
**Version:** 4.0  
...
Define the capability audit for the Plugin Runtime, covering least-privilege grants across storage, network, knowledge, AI, UI and other services.
