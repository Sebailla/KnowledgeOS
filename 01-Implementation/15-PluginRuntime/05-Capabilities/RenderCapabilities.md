...
Define the render capabilities for the Plugin Runtime, covering least-privilege grants across storage, network, knowledge, AI, UI and other services.
