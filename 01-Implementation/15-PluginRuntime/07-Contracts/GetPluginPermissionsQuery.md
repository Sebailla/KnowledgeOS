# Get Plugin Permissions Query

**Project:** KnowledgeOS  
**Section:** Implementation / Plugin Runtime / 07-Contracts  
**Document:** GetPluginPermissionsQuery  
**Version:** 4.0  
...
Define the get plugin permissions query for the Plugin Runtime, covering commands, queries, events, DTOs and compatibility.
