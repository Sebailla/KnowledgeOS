# Revoke Capability Command

**Project:** KnowledgeOS  
**Section:** Implementation / Plugin Runtime / 07-Contracts  
**Document:** RevokeCapabilityCommand  
**Version:** 4.0  
...
Define the revoke capability command for the Plugin Runtime, covering commands, queries, events, DTOs and compatibility.
