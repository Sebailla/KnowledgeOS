# Check Plugin Compatibility Query

**Project:** KnowledgeOS  
**Section:** Implementation / Plugin Runtime / 07-Contracts  
**Document:** CheckPluginCompatibilityQuery  
**Version:** 4.0  
...
Define the check plugin compatibility query for the Plugin Runtime, covering commands, queries, events, DTOs and compatibility.
...
- Plugin packages SHALL be treated as untrusted until validated.
- Checksums or signatures SHALL be verified according to policy.
- Dependency metadata SHALL be explicit and acyclic.
- Publisher identity SHALL remain distinct from plugin identity.
- Unknown required manifest semantics SHALL fail activation.
