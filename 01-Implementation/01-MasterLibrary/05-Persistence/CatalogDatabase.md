...
Define the catalog database for the KnowledgeOS Master Library implementation.
...
- Database schema identifiers are implementation details and SHALL NOT replace Domain identities.
- Every schema change SHALL include a versioned, restartable migration and rollback or recovery guidance.
