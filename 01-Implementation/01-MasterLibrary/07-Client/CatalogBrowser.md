...
**Project:** KnowledgeOS  
**Section:** Implementation / Master Library / 07-Client  
**Document:** CatalogBrowser  
**Version:** 4.0  
...
Define the catalog browser for the KnowledgeOS Master Library implementation.

## 2. Scope

This document covers client-side Master Library browsing and acquisition integration for the NAS-hosted Master Library and its client-facing integration.
...
- Catalog records SHALL preserve stable publication identity, version, availability and source provenance.
- Catalog queries SHALL support deterministic pagination and explicit compatibility versions.
- Client integration SHALL remain usable with locally acquired publications when the NAS is unavailable.
- Master Catalog browsing and Local Library membership SHALL remain distinct views and data scopes.
