...
Define the acquisition manager for the KnowledgeOS Master Library implementation.
...
- Acquisition SHALL be resumable, integrity-checked and idempotent.
- A successful acquisition SHALL preserve Master identity while creating local acquisition and source-item records.
