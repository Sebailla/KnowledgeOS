...
**Document:** PaginationAndOrdering  
**Version:** 4.0  
...
Define the pagination and ordering for Search and Discovery, covering query parsing, lexical, semantic, graph and hybrid execution.
