# Search Master Catalog Query

**Project:** KnowledgeOS  
**Section:** Implementation / Search and Discovery / 06-Contracts  
**Document:** SearchMasterCatalogQuery  
**Version:** 4.0  
...
Define the search master catalog query for Search and Discovery, covering commands, queries, events, DTOs and compatibility.
