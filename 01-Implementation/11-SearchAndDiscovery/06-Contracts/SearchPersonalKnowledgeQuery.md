# Search Personal Knowledge Query

**Project:** KnowledgeOS  
**Section:** Implementation / Search and Discovery / 06-Contracts  
**Document:** SearchPersonalKnowledgeQuery  
**Version:** 4.0  
...
Define the search personal knowledge query for Search and Discovery, covering commands, queries, events, DTOs and compatibility.
