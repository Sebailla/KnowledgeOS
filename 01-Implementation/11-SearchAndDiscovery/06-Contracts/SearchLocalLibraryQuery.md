# Search Local Library Query

**Project:** KnowledgeOS  
**Section:** Implementation / Search and Discovery / 06-Contracts  
**Document:** SearchLocalLibraryQuery  
**Version:** 4.0  
...
Define the search local library query for Search and Discovery, covering commands, queries, events, DTOs and compatibility.
