# Invalidate Search Index Command

**Project:** KnowledgeOS  
**Section:** Implementation / Search and Discovery / 06-Contracts  
**Document:** InvalidateSearchIndexCommand  
**Version:** 4.0  
...
Define the invalidate search index command for Search and Discovery, covering commands, queries, events, DTOs and compatibility.
