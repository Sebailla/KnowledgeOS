# Index Manifest Store

**Project:** KnowledgeOS  
**Section:** Implementation / Search and Discovery / 07-Persistence  
**Document:** IndexManifestStore  
**Version:** 4.0  
...
Define the index manifest store for Search and Discovery, covering index, manifest, preference, history and checkpoint persistence.
...
- Search history and preferences SHALL be treated as Personal Knowledge or personal local state.
- Search history SHALL NOT be written to the Master Library.
- Migrations SHALL preserve privacy scope and compatibility.
- Retention and deletion policies SHALL be explicit.
