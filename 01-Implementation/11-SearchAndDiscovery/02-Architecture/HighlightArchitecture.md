...
**Document:** HighlightArchitecture  
**Version:** 4.0  
...
Define the highlight architecture for Search and Discovery, covering search scopes, indexes, query pipeline, ranking and federation.
