...
**Document:** FederatedSearchArchitecture  
**Version:** 4.0  
...
Define the federated search architecture for Search and Discovery, covering search scopes, indexes, query pipeline, ranking and federation.
