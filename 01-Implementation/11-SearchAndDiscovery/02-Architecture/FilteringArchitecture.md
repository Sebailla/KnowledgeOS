...
**Document:** FilteringArchitecture  
**Version:** 4.0  
...
Define the filtering architecture for Search and Discovery, covering search scopes, indexes, query pipeline, ranking and federation.
