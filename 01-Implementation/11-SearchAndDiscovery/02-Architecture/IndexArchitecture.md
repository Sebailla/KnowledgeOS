...
**Project:** KnowledgeOS  
**Section:** Implementation / Search and Discovery / 02-Architecture  
**Document:** IndexArchitecture  
**Version:** 4.0  
...
Define the index architecture for Search and Discovery, covering search scopes, indexes, query pipeline, ranking and federation.
