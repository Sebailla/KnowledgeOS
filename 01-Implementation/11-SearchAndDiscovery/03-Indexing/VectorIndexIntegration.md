...
**Project:** KnowledgeOS  
**Section:** Implementation / Search and Discovery / 03-Indexing  
**Document:** VectorIndexIntegration  
**Version:** 4.0  
...
Define the vector index integration for Search and Discovery, covering local, personal, catalog, graph and vector indexing.
...
- Lexical, semantic, graph and vector results SHALL preserve their component scores.
- Embedding or graph similarity SHALL remain derived.
- Hybrid search SHALL use a versioned fusion strategy.
- Unavailable semantic or graph components SHALL degrade explicitly.
