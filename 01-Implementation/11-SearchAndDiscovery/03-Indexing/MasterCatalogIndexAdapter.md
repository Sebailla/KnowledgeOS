# Master Catalog Index Adapter

**Project:** KnowledgeOS  
**Section:** Implementation / Search and Discovery / 03-Indexing  
**Document:** MasterCatalogIndexAdapter  
**Version:** 4.0  
...
Define the master catalog index adapter for Search and Discovery, covering local, personal, catalog, graph and vector indexing.
