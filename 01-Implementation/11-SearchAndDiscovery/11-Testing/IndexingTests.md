...
**Project:** KnowledgeOS  
**Section:** Implementation / Search and Discovery / 11-Testing  
**Document:** IndexingTests  
**Version:** 4.0  
...
Define the indexing tests for Search and Discovery, covering correctness, isolation, privacy, offline and performance verification.
...
- Tests SHALL verify scope isolation and privacy filtering.
- Tests SHALL verify deterministic pagination and ranking for fixed versions.
- Offline tests SHALL prove local search without NAS availability.
- Completion SHALL demonstrate that index loss does not lose knowledge.
