...
Define the ranking tests for Search and Discovery, covering correctness, isolation, privacy, offline and performance verification.
...
- Ranking functions SHALL be versioned.
- Score normalization SHALL be deterministic.
- Personalization SHALL remain Personal Knowledge or local personal state.
- Authority-aware ranking SHALL not suppress required provenance.
- Rank explanations SHOULD expose the major contributing signals.
- Evaluation datasets SHALL use synthetic or approved content.
