...
**Project:** KnowledgeOS  
**Section:** Implementation / Web Application / 07-Operations  
...
Define the deployment profile for the optional KnowledgeOS Web Application, covering deployment, configuration, observability and release readiness.
...
- Operational telemetry MUST distinguish client, API, provider and server failures.
