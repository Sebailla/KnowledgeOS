...
**Document:** PersonalKnowledgeScope  
**Version:** 4.0  
...
Define the personal knowledge scope for the optional KnowledgeOS Web Application, covering Personal Knowledge editing, privacy and synchronization.
...
- Personal Knowledge changes MUST commit to the approved web-client state boundary before synchronization.
- Conflicts MUST preserve competing versions until an explicit merge.
- The synchronization provider SHALL NOT become Domain authority.
