...
**Project:** KnowledgeOS  
**Section:** Implementation / Web Application / 02-Architecture  
**Document:** AuthenticationArchitecture  
**Version:** 4.0  
...
Define the authentication architecture for the optional KnowledgeOS Web Application, covering web application structure and runtime integration.
...
- Authentication tokens MUST use secure browser storage patterns and short-lived credentials where possible.
- Cross-site scripting, request forgery, origin validation and content-security policy MUST be addressed.
- Publication content and Personal Knowledge MUST NOT appear in telemetry by default.
