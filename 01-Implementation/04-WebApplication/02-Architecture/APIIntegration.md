...
Define the apiintegration for the optional KnowledgeOS Web Application, covering web application structure and runtime integration.
...
- API compatibility and schema versions MUST be explicit.
- Transport DTOs MUST NOT leak internal persistence models.
