...
Define the master catalog browser for the optional KnowledgeOS Web Application, covering Master Catalog, remote publication access and browser-local availability.
