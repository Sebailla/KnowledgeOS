...
**Project:** KnowledgeOS  
**Section:** Implementation / Web Application / 03-Library  
**Document:** AvailabilityModel  
**Version:** 4.0  
...
Define the availability model for the optional KnowledgeOS Web Application, covering Master Catalog, remote publication access and browser-local availability.
...
- Offline behavior MUST be limited to explicitly cached and authorized content.
- Browser cache loss MUST NOT imply loss of authoritative knowledge.
- Storage quotas and eviction MUST be observable.
