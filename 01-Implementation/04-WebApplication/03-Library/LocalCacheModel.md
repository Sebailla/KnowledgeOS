...
Define the local cache model for the optional KnowledgeOS Web Application, covering Master Catalog, remote publication access and browser-local availability.
