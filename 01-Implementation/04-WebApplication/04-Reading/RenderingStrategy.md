...
Define the rendering strategy for the optional KnowledgeOS Web Application, covering browser reading, rendering, responsive behavior and search.
...
- Rendering MUST preserve UDM semantic order and approved DPM mappings.
- Responsive presentation MUST not modify canonical UDM or DPM.
- Accessibility reading order MUST be explicit and testable.
