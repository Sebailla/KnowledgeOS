...
Define the navigation architecture for the KnowledgeOS macOS application, covering macOS application architecture and runtime composition.
...
- Navigation state SHALL reference stable identities rather than transient view instances.
- Deep links and restoration paths SHALL validate availability and authorization.
