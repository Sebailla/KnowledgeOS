...
Define the event architecture for the KnowledgeOS macOS application, covering macOS application architecture and runtime composition.
...
- UI updates driven by events SHALL follow committed state.
- Event subscriptions SHALL be cancellable and lifecycle-bound.
