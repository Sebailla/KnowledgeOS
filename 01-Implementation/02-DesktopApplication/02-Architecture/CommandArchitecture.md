...
Define the command architecture for the KnowledgeOS macOS application, covering macOS application architecture and runtime composition.
...
- State-changing user intent SHALL be represented through commands.
- Retryable commands SHALL use idempotency and explicit concurrency handling.
