...
**Document:** WorkspaceArchitecture  
**Version:** 4.0  
...
Define the workspace architecture for the KnowledgeOS macOS application, covering macOS application architecture and runtime composition.
