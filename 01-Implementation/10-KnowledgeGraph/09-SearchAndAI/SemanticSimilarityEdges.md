...
**Document:** SemanticSimilarityEdges  
**Version:** 4.0  
...
Define the semantic similarity edges for the Knowledge Graph implementation, covering hybrid search, embeddings, AI reasoning and derived relationships.
