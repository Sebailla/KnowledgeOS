...
**Document:** RecommendationIntegration  
**Version:** 4.0  
...
Define the recommendation integration for the Knowledge Graph implementation, covering hybrid search, embeddings, AI reasoning and derived relationships.
