...
**Project:** KnowledgeOS  
**Section:** Implementation / Knowledge Graph / 10-Testing  
**Document:** ProjectionDeterminismTests  
**Version:** 4.0  
...
Define the projection determinism tests for the Knowledge Graph implementation, covering determinism, authority isolation, correctness, recovery and performance.
...
- Tests SHALL prove projection determinism and idempotency.
- Tests SHALL verify authority-layer isolation.
- Tests SHALL verify graph rebuild from authoritative sources.
- Performance tests SHALL use bounded and documented workloads.
- Completion SHALL demonstrate that graph persistence is not required to preserve canonical knowledge.
