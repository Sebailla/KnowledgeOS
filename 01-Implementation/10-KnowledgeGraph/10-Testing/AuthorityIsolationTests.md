...
**Document:** AuthorityIsolationTests  
**Version:** 4.0  
...
Define the authority isolation tests for the Knowledge Graph implementation, covering determinism, authority isolation, correctness, recovery and performance.
