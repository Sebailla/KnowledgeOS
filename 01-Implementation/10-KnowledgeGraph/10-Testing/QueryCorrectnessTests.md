...
**Document:** QueryCorrectnessTests  
**Version:** 4.0  
...
Define the query correctness tests for the Knowledge Graph implementation, covering determinism, authority isolation, correctness, recovery and performance.
...
- Traversal depth and result size SHALL be bounded.
- Ordering and pagination SHALL be deterministic.
- Authority filters SHALL be explicit.
- Hybrid search scores SHALL not change graph authority.
