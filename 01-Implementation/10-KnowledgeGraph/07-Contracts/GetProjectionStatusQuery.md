# Get Projection Status Query

**Project:** KnowledgeOS  
**Section:** Implementation / Knowledge Graph / 07-Contracts  
**Document:** GetProjectionStatusQuery  
**Version:** 4.0  
...
Define the get projection status query for the Knowledge Graph implementation, covering commands, queries, events, DTOs and compatibility.
