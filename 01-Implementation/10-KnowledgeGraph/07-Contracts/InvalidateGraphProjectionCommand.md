# Invalidate Graph Projection Command

**Project:** KnowledgeOS  
**Section:** Implementation / Knowledge Graph / 07-Contracts  
**Document:** InvalidateGraphProjectionCommand  
**Version:** 4.0  
...
Define the invalidate graph projection command for the Knowledge Graph implementation, covering commands, queries, events, DTOs and compatibility.
