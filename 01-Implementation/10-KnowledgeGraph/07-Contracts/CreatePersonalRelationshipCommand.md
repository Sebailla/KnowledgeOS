# Create Personal Relationship Command

**Project:** KnowledgeOS  
**Section:** Implementation / Knowledge Graph / 07-Contracts  
**Document:** CreatePersonalRelationshipCommand  
**Version:** 4.0  
...
Define the create personal relationship command for the Knowledge Graph implementation, covering commands, queries, events, DTOs and compatibility.
