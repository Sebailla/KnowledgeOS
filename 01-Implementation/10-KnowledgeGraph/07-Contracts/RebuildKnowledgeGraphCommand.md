# Rebuild Knowledge Graph Command

**Project:** KnowledgeOS  
**Section:** Implementation / Knowledge Graph / 07-Contracts  
**Document:** RebuildKnowledgeGraphCommand  
**Version:** 4.0  
...
Define the rebuild knowledge graph command for the Knowledge Graph implementation, covering commands, queries, events, DTOs and compatibility.
