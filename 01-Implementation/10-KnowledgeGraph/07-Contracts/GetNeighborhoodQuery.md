# Get Neighborhood Query

**Project:** KnowledgeOS  
**Section:** Implementation / Knowledge Graph / 07-Contracts  
**Document:** GetNeighborhoodQuery  
**Version:** 4.0  
...
Define the get neighborhood query for the Knowledge Graph implementation, covering commands, queries, events, DTOs and compatibility.
