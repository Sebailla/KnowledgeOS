# Confirm Derived Relationship Command

**Project:** KnowledgeOS  
**Section:** Implementation / Knowledge Graph / 07-Contracts  
**Document:** ConfirmDerivedRelationshipCommand  
**Version:** 4.0  
...
Define the confirm derived relationship command for the Knowledge Graph implementation, covering commands, queries, events, DTOs and compatibility.
...
- DTOs SHALL not expose graph-database implementation types.
- Long-running operations SHALL return workflow or job identity.
