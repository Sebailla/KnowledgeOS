...
Define the projection versioning for the Knowledge Graph implementation, covering deterministic projection from canonical, personal, derived and external sources.
