...
**Document:** ProjectionInvalidation  
**Version:** 4.0  
...
Define the projection invalidation for the Knowledge Graph implementation, covering deterministic projection from canonical, personal, derived and external sources.
