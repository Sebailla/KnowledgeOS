...
Define the traversal queries for the Knowledge Graph implementation, covering traversal, neighborhoods, paths, temporal filtering and hybrid queries.
