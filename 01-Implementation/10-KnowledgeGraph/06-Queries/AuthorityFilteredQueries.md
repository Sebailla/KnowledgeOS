# Authority Filtered Queries

**Project:** KnowledgeOS  
**Section:** Implementation / Knowledge Graph / 06-Queries  
**Document:** AuthorityFilteredQueries  
**Version:** 4.0  
...
Define the authority filtered queries for the Knowledge Graph implementation, covering traversal, neighborhoods, paths, temporal filtering and hybrid queries.
