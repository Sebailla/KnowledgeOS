...
**Project:** KnowledgeOS  
**Section:** Implementation / Knowledge Graph / 03-GraphModel  
...
Define the external references for the Knowledge Graph implementation, covering vertices, edges, identity, authority, ontology and validation.
