...
**Document:** TemporalRelationships  
**Version:** 4.0  
...
Define the temporal relationships for the Knowledge Graph implementation, covering vertices, edges, identity, authority, ontology and validation.
