...
Define the adjacency indexes for the Knowledge Graph implementation, covering graph storage, indexes, manifests, checkpoints, migrations and recovery.
