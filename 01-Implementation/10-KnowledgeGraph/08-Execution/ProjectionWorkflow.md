...
**Project:** KnowledgeOS  
**Section:** Implementation / Knowledge Graph / 08-Execution  
**Document:** ProjectionWorkflow  
**Version:** 4.0  
...
Define the projection workflow for the Knowledge Graph implementation, covering workflows, jobs, retries, concurrency, cancellation and resume.
...
- Parallel projection SHALL preserve deterministic merge semantics.
- Retries SHALL reconcile unknown completion state.
- Cancellation SHALL preserve completed consistent partitions and checkpoints.
- Rebuild jobs SHALL not block unrelated local reading and annotation operations unnecessarily.
