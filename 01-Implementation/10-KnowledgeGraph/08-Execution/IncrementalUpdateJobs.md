...
**Document:** IncrementalUpdateJobs  
**Version:** 4.0  
...
Define the incremental update jobs for the Knowledge Graph implementation, covering workflows, jobs, retries, concurrency, cancellation and resume.
