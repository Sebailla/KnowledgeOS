...
**Document:** ProjectionArchitecture  
**Version:** 4.0  
...
Define the projection architecture for the Knowledge Graph implementation, covering graph layers, projection, queries, indexes, storage and versioning.
