...
**Document:** IncrementalUpdateArchitecture  
**Version:** 4.0  
...
Define the incremental update architecture for the Knowledge Graph implementation, covering graph layers, projection, queries, indexes, storage and versioning.
