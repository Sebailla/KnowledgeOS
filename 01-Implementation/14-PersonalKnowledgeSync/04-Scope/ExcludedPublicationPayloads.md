# Excluded Publication Payloads

**Project:** KnowledgeOS  
**Section:** Implementation / Personal Knowledge Sync / 04-Scope  
**Document:** ExcludedPublicationPayloads  
**Version:** 4.0  
...
Define the excluded publication payloads for Personal Knowledge synchronization, covering the exact Personal Knowledge entities included and publication data excluded.
...
- Each synchronized entity type SHALL define identity, versioning, merge and deletion behavior.
- Publication references SHALL use stable KnowledgeOS identities.
- Personal assets SHALL follow explicit size, integrity and privacy limits.
- Excluded publication data SHALL remain excluded even when referenced by Personal Knowledge.
