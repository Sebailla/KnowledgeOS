...
Define the provider architecture for Personal Knowledge synchronization, covering change tracking, envelopes, conflicts, merge, tombstones and provider boundaries.
