...
**Document:** ChangeTrackingArchitecture  
**Version:** 4.0  
...
Define the change tracking architecture for Personal Knowledge synchronization, covering change tracking, envelopes, conflicts, merge, tombstones and provider boundaries.
