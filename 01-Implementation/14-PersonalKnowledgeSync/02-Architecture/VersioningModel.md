...
Define the versioning model for Personal Knowledge synchronization, covering change tracking, envelopes, conflicts, merge, tombstones and provider boundaries.
