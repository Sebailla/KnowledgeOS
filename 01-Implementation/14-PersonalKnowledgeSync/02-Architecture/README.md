...
Define the architecture guide for Personal Knowledge synchronization, covering change tracking, envelopes, conflicts, merge, tombstones and provider boundaries.
