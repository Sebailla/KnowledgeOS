...
**Project:** KnowledgeOS  
**Section:** Implementation / Personal Knowledge Sync / 02-Architecture  
**Document:** TombstoneArchitecture  
**Version:** 4.0  
...
Define the tombstone architecture for Personal Knowledge synchronization, covering change tracking, envelopes, conflicts, merge, tombstones and provider boundaries.
