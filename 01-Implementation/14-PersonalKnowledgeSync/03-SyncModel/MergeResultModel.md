...
**Project:** KnowledgeOS  
**Section:** Implementation / Personal Knowledge Sync / 03-SyncModel  
**Document:** MergeResultModel  
**Version:** 4.0  
...
Define the merge result model for Personal Knowledge synchronization, covering identity, versions, changes, cursors, checkpoints and convergence.
