# Synchronize Personal Knowledge Command

**Project:** KnowledgeOS  
**Section:** Implementation / Personal Knowledge Sync / 06-Contracts  
**Document:** SynchronizePersonalKnowledgeCommand  
**Version:** 4.0  
...
Define the synchronize personal knowledge command for Personal Knowledge synchronization, covering commands, queries, events, DTOs and compatibility.
