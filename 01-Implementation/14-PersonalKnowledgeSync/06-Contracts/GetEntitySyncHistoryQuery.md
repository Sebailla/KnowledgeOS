# Get Entity Sync History Query

**Project:** KnowledgeOS  
**Section:** Implementation / Personal Knowledge Sync / 06-Contracts  
**Document:** GetEntitySyncHistoryQuery  
**Version:** 4.0  
...
Define the get entity sync history query for Personal Knowledge synchronization, covering commands, queries, events, DTOs and compatibility.
