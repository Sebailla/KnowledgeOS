# Get Provider Capabilities Query

**Project:** KnowledgeOS  
**Section:** Implementation / Personal Knowledge Sync / 06-Contracts  
**Document:** GetProviderCapabilitiesQuery  
**Version:** 4.0  
...
Define the get provider capabilities query for Personal Knowledge synchronization, covering commands, queries, events, DTOs and compatibility.
