# Resolve Sync Conflict Command

**Project:** KnowledgeOS  
**Section:** Implementation / Personal Knowledge Sync / 06-Contracts  
**Document:** ResolveSyncConflictCommand  
**Version:** 4.0  
...
Define the resolve sync conflict command for Personal Knowledge synchronization, covering commands, queries, events, DTOs and compatibility.
