# Purge Expired Tombstones Command

**Project:** KnowledgeOS  
**Section:** Implementation / Personal Knowledge Sync / 06-Contracts  
**Document:** PurgeExpiredTombstonesCommand  
**Version:** 4.0  
...
Define the purge expired tombstones command for Personal Knowledge synchronization, covering commands, queries, events, DTOs and compatibility.
...
- Long-running synchronization SHALL return workflow or job identity.
- Events SHALL follow committed local state.
- DTOs SHALL not expose CloudKit implementation types.
