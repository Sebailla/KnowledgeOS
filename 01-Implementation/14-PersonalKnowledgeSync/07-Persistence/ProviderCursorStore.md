...
Define the provider cursor store for Personal Knowledge synchronization, covering journals, sync state, conflicts, tombstones, cursors and retention.
