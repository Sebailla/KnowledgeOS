...
**Project:** KnowledgeOS  
**Section:** Implementation / Personal Knowledge Sync / 07-Persistence  
**Document:** TombstoneStore  
**Version:** 4.0  
...
Define the tombstone store for Personal Knowledge synchronization, covering journals, sync state, conflicts, tombstones, cursors and retention.
...
- The change journal SHALL be durable before provider publication.
- Sync state SHALL remain separate from Personal Knowledge content.
- Retention SHALL balance convergence, privacy and storage constraints.
- Migrations SHALL preserve pending operations and conflicts.
