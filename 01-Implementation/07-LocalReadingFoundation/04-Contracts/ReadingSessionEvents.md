...
**Project:** KnowledgeOS  
**Section:** Implementation / Local Reading Foundation / 04-Contracts  
**Document:** ReadingSessionEvents  
**Version:** 4.0  
...
Define the reading session events for the Local Reading Foundation module, covering commands, queries, events, DTOs and compatibility.
...
- Contracts SHALL be versioned and immutable.
- Retryable commands SHALL use idempotency.
- Events SHALL follow committed state.
- DTOs SHALL not expose local database rows or platform UI types.
