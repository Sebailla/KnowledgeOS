...
**Document:** ResolveAvailabilityQuery  
**Version:** 4.0  
...
Define the resolve availability query for the Local Reading Foundation module, covering commands, queries, events, DTOs and compatibility.
