...
Define the close publication command for the Local Reading Foundation module, covering commands, queries, events, DTOs and compatibility.
...
- Availability resolution SHALL distinguish local, remote, evicted, corrupt and unavailable states.
- Opening SHALL fail explicitly when required local payloads are unavailable.
- The module SHALL NOT silently start acquisition.
