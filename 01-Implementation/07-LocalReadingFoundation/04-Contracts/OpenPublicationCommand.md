...
**Document:** OpenPublicationCommand  
**Version:** 4.0  
...
Define the open publication command for the Local Reading Foundation module, covering commands, queries, events, DTOs and compatibility.
