...
**Document:** AvailabilityResolution  
**Version:** 4.0  
...
Define the availability resolution for the Local Reading Foundation module, covering technical architecture, state, dependencies and failure behavior.
