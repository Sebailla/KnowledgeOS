...
Define the reading session architecture for the Local Reading Foundation module, covering technical architecture, state, dependencies and failure behavior.
