...
**Document:** RecentItemsPersistence  
**Version:** 4.0  
...
Define the recent items persistence for the Local Reading Foundation module, covering local reading session, position and recent-item persistence.
