...
**Document:** ReadingSessionPersistence  
**Version:** 4.0  
...
Define the reading session persistence for the Local Reading Foundation module, covering local reading session, position and recent-item persistence.
