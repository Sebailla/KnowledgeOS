...
**Document:** LocalAvailabilityMapping  
**Version:** 4.0  
...
Define the local availability mapping for the Local Reading Foundation module, covering implementation mapping to approved Domain identities and authority.
