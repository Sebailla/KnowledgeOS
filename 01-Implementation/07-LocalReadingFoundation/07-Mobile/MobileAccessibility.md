...
**Project:** KnowledgeOS  
**Section:** Implementation / Local Reading Foundation / 07-Mobile  
**Document:** MobileAccessibility  
**Version:** 4.0  
...
Define the mobile accessibility for the Local Reading Foundation module, covering iPhone and iPad reader integration.
...
- Mobile integration SHALL support scene lifecycle and compact/regular size classes.
- Apple Pencil readiness SHALL preserve future annotation attachment points without embedding annotation ownership in this module.
