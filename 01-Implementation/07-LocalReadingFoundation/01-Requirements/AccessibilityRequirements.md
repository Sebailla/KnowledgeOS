...
**Project:** KnowledgeOS  
**Section:** Implementation / Local Reading Foundation / 01-Requirements  
**Document:** AccessibilityRequirements  
**Version:** 4.0  
...
Define the accessibility requirements for the Local Reading Foundation module, covering requirements and acceptance boundaries for opening and reading locally available publications.
...
- Requirements SHALL include offline, missing-asset, corrupt-cache and unsupported-format behavior.
- Acceptance criteria SHALL be testable on macOS and applicable mobile profiles.
- Accessibility reading order SHALL follow UDM semantic order unless an approved alternate flow exists.
- VoiceOver, dynamic type, contrast and reduced-motion behavior SHALL be tested.
