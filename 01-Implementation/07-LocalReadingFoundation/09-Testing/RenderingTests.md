...
**Project:** KnowledgeOS  
**Section:** Implementation / Local Reading Foundation / 09-Testing  
**Document:** RenderingTests  
**Version:** 4.0  
...
Define the rendering tests for the Local Reading Foundation module, covering module verification and conformance.
...
- Source-faithful and reflowed modes SHALL be identified explicitly.
- Render plans SHALL preserve UDM/DPM mappings for navigation and future annotations.
- Missing assets SHALL yield explicit placeholders or failures according to profile.
- Render cache keys SHALL include source and representation versions.
- Tests SHALL cover offline operation, corrupt caches, missing assets, migration and restoration.
- Completion SHALL demonstrate that acquisition and synchronization are not implemented inside this module.
