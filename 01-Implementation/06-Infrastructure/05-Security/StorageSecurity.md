...
**Project:** KnowledgeOS  
**Section:** Implementation / Infrastructure / 05-Security  
**Document:** StorageSecurity  
**Version:** 4.0  
...
Define the storage security for KnowledgeOS infrastructure, covering host, container, database, storage and audit security.
...
- Threats SHALL be reviewed against assets, trust boundaries and abuse cases.
- Security updates SHALL follow a documented process.
- Audit records SHALL be protected from tampering.
- Default configurations SHALL be secure.
