...
**Document:** InfrastructureSecurityModel  
**Version:** 4.0  
...
Define the infrastructure security model for KnowledgeOS infrastructure, covering host, container, database, storage and audit security.
