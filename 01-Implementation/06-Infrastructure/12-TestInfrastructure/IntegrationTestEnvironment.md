...
**Document:** IntegrationTestEnvironment  
**Version:** 4.0  
...
Define the integration test environment for KnowledgeOS infrastructure, covering repeatable infrastructure for integration, end-to-end, performance and recovery testing.
