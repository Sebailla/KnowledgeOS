...
**Document:** PerformanceTestEnvironment  
**Version:** 4.0  
...
Define the performance test environment for KnowledgeOS infrastructure, covering repeatable infrastructure for integration, end-to-end, performance and recovery testing.
