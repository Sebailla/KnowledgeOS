...
**Document:** RecoveryTestEnvironment  
**Version:** 4.0  
...
Define the recovery test environment for KnowledgeOS infrastructure, covering repeatable infrastructure for integration, end-to-end, performance and recovery testing.
...
- Secret rotation SHALL be supported without embedding credentials in artifacts.
- Developer secrets SHALL be isolated from production.
- Revocation SHALL be observable.
- Backup sets SHALL preserve consistency between PostgreSQL and authoritative files.
- Restore procedures SHALL be tested regularly.
- Recovery point and recovery time objectives SHALL be documented.
- Offsite copies SHALL be encrypted and independently verifiable.
