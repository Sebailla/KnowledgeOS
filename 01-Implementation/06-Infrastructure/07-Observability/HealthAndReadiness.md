...
**Project:** KnowledgeOS  
**Section:** Implementation / Infrastructure / 07-Observability  
**Document:** HealthAndReadiness  
**Version:** 4.0  
...
Define the health and readiness for KnowledgeOS infrastructure, covering logs, metrics, traces, health, alerts and privacy.
...
- Telemetry SHALL use bounded-cardinality metadata.
- Publication content, annotations and private paths SHALL be excluded by default.
- Alerts SHALL distinguish availability, integrity, security, capacity and backup failures.
