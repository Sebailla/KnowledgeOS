# High Availability Position

**Project:** KnowledgeOS  
**Section:** Implementation / Infrastructure / 02-PostgreSQL  
**Document:** HighAvailabilityPosition  
**Version:** 4.0  
...
Define the high availability position for KnowledgeOS infrastructure, covering PostgreSQL configuration, ownership, migrations and operational integration.
