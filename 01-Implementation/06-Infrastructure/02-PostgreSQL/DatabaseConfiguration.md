...
**Document:** DatabaseConfiguration  
**Version:** 4.0  
...
Define the database configuration for KnowledgeOS infrastructure, covering PostgreSQL configuration, ownership, migrations and operational integration.
