...
**Document:** DeploymentArchitecture  
**Version:** 4.0  
...
Define the deployment architecture for KnowledgeOS infrastructure, covering environment, NAS, client, web, upgrades and rollback.
