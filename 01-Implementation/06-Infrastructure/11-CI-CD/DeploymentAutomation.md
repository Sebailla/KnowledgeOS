...
**Project:** KnowledgeOS  
**Section:** Implementation / Infrastructure / 11-CI-CD  
**Document:** DeploymentAutomation  
**Version:** 4.0  
...
Define the deployment automation for KnowledgeOS infrastructure, covering build, test, security, publication and deployment automation.
