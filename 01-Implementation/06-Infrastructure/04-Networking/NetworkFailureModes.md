...
**Project:** KnowledgeOS  
**Section:** Implementation / Infrastructure / 04-Networking  
**Document:** NetworkFailureModes  
**Version:** 4.0  
...
Define the network failure modes for KnowledgeOS infrastructure, covering service connectivity, TLS, proxying, discovery and network failure behavior.
...
- External traffic SHALL use authenticated encrypted transport.
- Service exposure SHALL be minimal.
- Internal and external network boundaries SHALL be explicit.
- Network outages SHALL not prevent local clients from using locally available content.
