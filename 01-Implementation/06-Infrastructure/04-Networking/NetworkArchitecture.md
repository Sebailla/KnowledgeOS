...
Define the network architecture for KnowledgeOS infrastructure, covering service connectivity, TLS, proxying, discovery and network failure behavior.
