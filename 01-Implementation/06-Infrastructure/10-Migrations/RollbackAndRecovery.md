...
Define the rollback and recovery for KnowledgeOS infrastructure, covering database, storage, identity and configuration migration.
...
- Deployment artifacts SHALL be reproducible and signed where appropriate.
- Upgrades SHALL validate backups and migrations before destructive steps.
- Rollback SHALL not silently revert incompatible persisted data.
- Environment promotion SHALL use immutable artifacts.
