...
**Document:** ConfigurationMigrations  
**Version:** 4.0  
...
Define the configuration migrations for KnowledgeOS infrastructure, covering database, storage, identity and configuration migration.
