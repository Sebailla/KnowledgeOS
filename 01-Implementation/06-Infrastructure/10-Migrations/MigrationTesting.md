...
**Project:** KnowledgeOS  
**Section:** Implementation / Infrastructure / 10-Migrations  
**Document:** MigrationTesting  
**Version:** 4.0  
...
Define the migration testing for KnowledgeOS infrastructure, covering database, storage, identity and configuration migration.
...
- Migrations SHALL be versioned, resumable and idempotent where retryable.
- Identity, authority and provenance SHALL be preserved.
- Migrations SHALL be tested against supported prior versions.
- Failure SHALL leave a recoverable state.
