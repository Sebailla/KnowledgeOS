...
**Document:** FileStorageMigrations  
**Version:** 4.0  
...
Define the file storage migrations for KnowledgeOS infrastructure, covering database, storage, identity and configuration migration.
...
- Authoritative source files SHALL be immutable after registration.
- Physical paths SHALL NOT become Domain identity.
- Integrity checks SHOULD use cryptographic hashes.
- Derived storage MAY be deleted and rebuilt.
- Capacity alerts SHALL precede service exhaustion.
