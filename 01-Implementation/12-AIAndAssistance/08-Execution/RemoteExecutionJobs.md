...
**Project:** KnowledgeOS  
**Section:** Implementation / AI and Assistance / 08-Execution  
**Document:** RemoteExecutionJobs  
**Version:** 4.0  
...
Define the remote execution jobs for AI and Assistance, covering workflows, jobs, retries, cancellation, resources and resume.
...
- Unknown remote completion state SHALL be reconciled before retry.
- Cancellation SHALL preserve completed consistent artifacts and usage records.
