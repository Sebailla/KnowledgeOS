...
**Document:** GenerateFlashcardsCommand  
**Version:** 4.0  
...
Define the generate flashcards command for AI and Assistance, covering commands, queries, events, DTOs and compatibility.
