# Get Available Models Query

**Project:** KnowledgeOS  
**Section:** Implementation / AI and Assistance / 06-Contracts  
**Document:** GetAvailableModelsQuery  
**Version:** 4.0  
...
Define the get available models query for AI and Assistance, covering commands, queries, events, DTOs and compatibility.
