# Ask Knowledge Question Command

**Project:** KnowledgeOS  
**Section:** Implementation / AI and Assistance / 06-Contracts  
**Document:** AskKnowledgeQuestionCommand  
**Version:** 4.0  
...
Define the ask knowledge question command for AI and Assistance, covering commands, queries, events, DTOs and compatibility.
...
- Capability outputs SHALL identify whether they are generated, extracted, suggested or confirmed.
- Suggestions SHALL not modify canonical or Personal Knowledge automatically.
- User acceptance SHALL create a new explicit action or artifact.
- Contracts SHALL be immutable and versioned.
- Long-running tasks SHALL return workflow or job identity.
- Events SHALL follow committed artifact or task state.
- DTOs SHALL not expose provider SDK types.
