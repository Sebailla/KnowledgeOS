...
**Project:** KnowledgeOS  
**Section:** Implementation / AI and Assistance / 04-Context  
**Document:** RetrievalAugmentedContext  
**Version:** 4.0  
...
Define the retrieval augmented context for AI and Assistance, covering context assembly, retrieval, grounding and privacy.
...
- Context assembly SHALL use minimum necessary authorized data.
- Retrieved context SHALL preserve identity, authority and provenance.
- Personal Knowledge context SHALL remain user-scoped.
- Context truncation SHALL be deterministic and observable.
- Grounded answers SHALL identify unsupported claims or uncertainty.
