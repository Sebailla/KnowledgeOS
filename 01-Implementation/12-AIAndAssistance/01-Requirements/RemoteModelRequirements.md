...
**Project:** KnowledgeOS  
**Section:** Implementation / AI and Assistance / 01-Requirements  
**Document:** RemoteModelRequirements  
**Version:** 4.0  
...
Define the remote model requirements for AI and Assistance, covering AI and assistance requirements, privacy, cost and safety boundaries.
...
- UI SHALL distinguish generated output from source-backed content.
- Users SHALL be able to inspect model, provider and source references.
- Privacy controls SHALL be visible before remote execution.
- UI SHALL use public AI contracts and SHALL not call providers directly.
