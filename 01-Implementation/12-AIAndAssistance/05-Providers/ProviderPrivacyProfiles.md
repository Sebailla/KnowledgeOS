...
**Document:** ProviderPrivacyProfiles  
**Version:** 4.0  
...
Define the provider privacy profiles for AI and Assistance, covering local, remote, embedding and multimodal provider integration.
