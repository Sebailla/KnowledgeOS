...
**Project:** KnowledgeOS  
**Section:** Implementation / AI and Assistance / 02-Architecture  
**Document:** ProviderSelectionArchitecture  
**Version:** 4.0  
...
Define the provider selection architecture for AI and Assistance, covering tasks, providers, context, prompts, validation and policy.
