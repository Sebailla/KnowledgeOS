...
**Project:** KnowledgeOS  
**Section:** Implementation / Mobile Application / 05-Annotations  
**Document:** AnnotationArchitecture  
**Version:** 4.0  
...
Define the annotation architecture for the KnowledgeOS native mobile applications.
...
- Dependency direction SHALL follow Architecture V4.
- Application composition SHALL be deterministic and testable.
- iPhone and iPad SHALL share Domain and Platform contracts while allowing platform-adaptive presentation.
- SwiftUI and UIKit-specific types SHALL remain inside Implementation boundaries.
- Annotations SHALL use stable anchors and SHALL not mutate canonical publication content.
- Apple Pencil drawings SHALL use Personal asset identities and versioned attachment metadata.
- Orphaned annotations SHALL remain recoverable and re-anchoring history SHALL be preserved.
