...
**Project:** KnowledgeOS  
**Section:** Implementation / Mobile Application / 07-Testing  
**Document:** SyncTests  
**Version:** 4.0  
...
Define the synchronization tests for the KnowledgeOS native mobile applications.
...
- CloudKit record types and cursors SHALL remain Integration details.
- Conflicts SHALL preserve all competing Personal Knowledge versions until merge.
- Deletion SHALL converge through tombstones or equivalent versioned semantics.
- NAS availability SHALL not affect Personal Knowledge synchronization.
- Verification SHALL include offline, interruption, conflict, migration and recovery behavior.
- Diagnostics SHALL not expose publication content, Personal Knowledge, credentials or private paths.
