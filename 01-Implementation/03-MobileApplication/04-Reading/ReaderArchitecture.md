...
**Project:** KnowledgeOS  
**Section:** Implementation / Mobile Application / 04-Reading  
**Document:** ReaderArchitecture  
**Version:** 4.0  
...
Define the reader architecture for the KnowledgeOS native mobile applications.
...
- Reading SHALL preserve UDM semantic order and DPM presentation mappings.
- Reader state SHALL remain Personal Knowledge or restorable local state according to scope.
- Accessibility SHALL support VoiceOver, Dynamic Type, reduced motion and platform reading conventions.
