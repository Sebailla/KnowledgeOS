...
**Document:** DuplicateEvidenceModel  
**Version:** 4.0  
...
Define the duplicate evidence model for the Import and Acquisition module, covering pipeline, workflow, state and technical architecture.
...
- Identical bytes SHALL NOT automatically imply one Work or Knowledge Object.
- Distinct custody and acquisition records SHALL remain traceable.
