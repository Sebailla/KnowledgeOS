...
**Document:** SourceDiscoveryArchitecture  
**Version:** 4.0  
...
Define the source discovery architecture for the Import and Acquisition module, covering pipeline, workflow, state and technical architecture.
