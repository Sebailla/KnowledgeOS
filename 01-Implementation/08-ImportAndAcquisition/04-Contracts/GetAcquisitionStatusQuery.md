# Get Acquisition Status Query

**Project:** KnowledgeOS  
**Section:** Implementation / Import and Acquisition / 04-Contracts  
**Document:** GetAcquisitionStatusQuery  
**Version:** 4.0  
...
Define the get acquisition status query for the Import and Acquisition module, covering commands, queries, events, DTOs and compatibility.
...
- Retryable mutations SHALL use idempotency keys.
- Events SHALL follow committed state.
- DTOs SHALL not expose database rows, filesystem paths or framework objects.
