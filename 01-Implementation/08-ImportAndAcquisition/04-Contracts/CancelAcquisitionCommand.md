...
**Document:** CancelAcquisitionCommand  
**Version:** 4.0  
...
Define the cancel acquisition command for the Import and Acquisition module, covering commands, queries, events, DTOs and compatibility.
