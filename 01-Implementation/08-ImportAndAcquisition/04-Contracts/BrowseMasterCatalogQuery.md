# Browse Master Catalog Query

**Project:** KnowledgeOS  
**Section:** Implementation / Import and Acquisition / 04-Contracts  
**Document:** BrowseMasterCatalogQuery  
**Version:** 4.0  
...
Define the browse master catalog query for the Import and Acquisition module, covering commands, queries, events, DTOs and compatibility.
