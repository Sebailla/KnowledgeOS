# Request Acquisition Command

**Project:** KnowledgeOS  
**Section:** Implementation / Import and Acquisition / 04-Contracts  
**Document:** RequestAcquisitionCommand  
**Version:** 4.0  
...
Define the request acquisition command for the Import and Acquisition module, covering commands, queries, events, DTOs and compatibility.
