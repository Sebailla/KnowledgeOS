# Resume Acquisition Command

**Project:** KnowledgeOS  
**Section:** Implementation / Import and Acquisition / 04-Contracts  
**Document:** ResumeAcquisitionCommand  
**Version:** 4.0  
...
Define the resume acquisition command for the Import and Acquisition module, covering commands, queries, events, DTOs and compatibility.
