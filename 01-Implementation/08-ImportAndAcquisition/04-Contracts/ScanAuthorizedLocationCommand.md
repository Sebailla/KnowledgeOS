# Scan Authorized Location Command

**Project:** KnowledgeOS  
**Section:** Implementation / Import and Acquisition / 04-Contracts  
**Document:** ScanAuthorizedLocationCommand  
**Version:** 4.0  
...
Define the scan authorized location command for the Import and Acquisition module, covering commands, queries, events, DTOs and compatibility.
