...
**Document:** DerivedArtifactInvalidation  
**Version:** 4.0  
...
Define the derived artifact invalidation for the Import and Acquisition module, covering handoff to metadata, OCR, UDM, DPM and derived processing.
