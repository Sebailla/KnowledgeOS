# Metadata Extraction Handoff

**Project:** KnowledgeOS  
**Section:** Implementation / Import and Acquisition / 09-Processing  
**Document:** MetadataExtractionHandoff  
**Version:** 4.0  
...
Define the metadata extraction handoff for the Import and Acquisition module, covering handoff to metadata, OCR, UDM, DPM and derived processing.
...
- Processing handoff SHALL identify source version, processor profile and provenance.
- Derived artifacts SHALL remain rebuildable.
- Reprocessing SHALL preserve stable identities where continuity remains.
