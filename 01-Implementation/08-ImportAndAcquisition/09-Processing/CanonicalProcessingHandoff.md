...
**Document:** CanonicalProcessingHandoff  
**Version:** 4.0  
...
Define the canonical processing handoff for the Import and Acquisition module, covering handoff to metadata, OCR, UDM, DPM and derived processing.
