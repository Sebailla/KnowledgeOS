...
Define the local scan tests for the Import and Acquisition module, covering verification, resilience, security and conformance.
...
- Scanning SHALL honor platform sandbox and security-scoped access rules.
- The scanner SHALL checkpoint large scans and avoid duplicate discovery records.
- Hidden, temporary and excluded files SHALL follow explicit policy.
