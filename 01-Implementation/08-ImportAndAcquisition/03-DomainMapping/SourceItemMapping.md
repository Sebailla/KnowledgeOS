...
Define the source item mapping for the Import and Acquisition module, covering implementation mapping to Knowledge Objects, sources, identities and availability.
