...
Define the domain mapping guide for the Import and Acquisition module, covering implementation mapping to Knowledge Objects, sources, identities and availability.
