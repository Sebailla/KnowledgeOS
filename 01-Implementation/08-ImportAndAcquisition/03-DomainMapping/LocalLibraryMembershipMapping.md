# Local Library Membership Mapping

**Project:** KnowledgeOS  
**Section:** Implementation / Import and Acquisition / 03-DomainMapping  
**Document:** LocalLibraryMembershipMapping  
**Version:** 4.0  
...
Define the local library membership mapping for the Import and Acquisition module, covering implementation mapping to Knowledge Objects, sources, identities and availability.
