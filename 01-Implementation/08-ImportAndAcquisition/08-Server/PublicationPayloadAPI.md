# Publication Payload Api

**Project:** KnowledgeOS  
**Section:** Implementation / Import and Acquisition / 08-Server  
**Document:** PublicationPayloadAPI  
**Version:** 4.0  
...
Define the publication payload api for the Import and Acquisition module, covering Master Catalog and publication delivery APIs.
...
- Acquisition SHALL preserve Master publication identity and source version.
- Transfers SHOULD support range requests or equivalent resumable delivery.
- Unknown completion state SHALL be reconciled by acquisition identity before retry.
- A completed transfer SHALL be checksum-verified before registration.
- Server APIs SHALL preserve Master authority and expose only approved public contracts.
- Authorization SHALL be evaluated before catalog or payload access.
- Rate limits SHALL not create ambiguous acquisition state.
