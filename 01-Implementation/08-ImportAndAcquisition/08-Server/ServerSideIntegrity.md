...
Define the server side integrity for the Import and Acquisition module, covering Master Catalog and publication delivery APIs.
...
- Cryptographic checksums SHOULD be recorded for managed bytes.
- Integrity failure SHALL quarantine the payload and prevent publication.
- Checksum algorithms and versions SHALL be explicit.
